...
namespace MakinaTurkiye.Payment.Providers
{
    public class VakifbankPaymentProvider : IPaymentProvider
    {
        ...
        public VakifbankPaymentProvider()
        {
        ...
        public async Task<VerifyGatewayResult> VerifyGateway(VerifyGatewayRequest request, PaymentGatewayRequest gatewayRequest, FormCollection form)
        {
            if (form == null)
            {
