...
namespace Trinnk.Services.Stores
{
    public class StoreDealerService : BaseService, IStoreDealerService
    {
        ...
        private const string STOREDEALERS_BY_MAIN_PARTY_ID_KEY = "storedealer.bymainpartyid-{0}-{1}";
        private const string STOREDEALERS_BY_STTORE_DEALER_ID_KEY = "storedealer.bystoredealerid-{0}";
        ...
        public void InsertStoreDealer(StoreDealer storeDealer)
        {
            ...
            _cacheManager.RemoveByPattern("trinnk.storedealer");
        }
