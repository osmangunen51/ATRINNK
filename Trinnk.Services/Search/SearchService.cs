...
namespace Trinnk.Services.Search
{
    public partial class SearchService : ISearchService
    {
        ...
        private readonly TrinnkConfig _config;
        ...
        public SearchService(IDbContext dbContext, IDataProvider dataProvider, TrinnkConfig config)
        {
        ...
        public void CreateAndYukleSuggestSearchIndex()
        {
            ...
            List<Trinnk.Services.Search.Product> Liste = new List<Search.Product>();
            int index = 0;
            foreach (var SonucItem in Result)
            {
                ...
                Trinnk.Services.Search.Product Kayit = new Trinnk.Services.Search.Product()
                {
                    Name = SonucItem.Name,
                    Url = "",
        ...
        //                              new Trinnk.Services.Search.Product()
        //                              {
        //                                  Name = Snc.Name,
        //                                  Suggest = new CompletionField()
        //                                  {
        ...
        //            }
        //            int index = 0;
        //            Liste = Liste.Distinct<Trinnk.Services.Search.Product>().ToList();
        ...
        public void CreateProductSearchIndex(List<Trinnk.Services.Search.Product> Liste)
        {
            bool isCreated = ElasticSearchClient.CreateIndex(GlobalSuggetSearchIndexName.ToLowerInvariant());
            if (isCreated)
            {
        ...
        public void CreateCategorySearchIndex(List<Trinnk.Services.Search.Product> Liste)
        {
