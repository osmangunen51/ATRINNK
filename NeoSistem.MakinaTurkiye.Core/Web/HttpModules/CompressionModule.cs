...
namespace NeoSistem.MakinaTurkiye.Core.Web.HttpModules
{
    /// <summary>
    ...
    public sealed class CompressionModule : IHttpModule
    {
        ...
        void context_PostReleaseRequestState(object sender, EventArgs e)
        {
            ...
            if (context.CurrentHandler is System.Web.Mvc.MvcHandler && context.Request["HTTP_X_MICROSOFTAJAX"] == null && context.Request.HttpMethod == "GET")
            {
            ...
            else if (context.Request.Path.Contains("WebResource.axd"))
            {
        ...
        private class WebResourceFilter : Stream
        {
            ...
            public string Evaluator(Match match)
            {
                ...
                return match.Value.Replace(relative, "~/script.axd?path=" + HttpUtility.UrlEncode(absolute + relative));
            }
            #endregion
