        ...
        Basla:
            try
            {
                ...
                if (config.PinDurum)
                {
                    ...
                    using (MakinaTurkiye.Pinterest.Istemci PinIstemci = new MakinaTurkiye.Pinterest.Istemci(config.PinUsername, config.PinPassword, Proxy))
                    {
                        ...
                        if (IslemDurum.Status)
                        {
                            ...
                            foreach (var productitm in ProductList)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (!ProductPageUrl.Contains("www.makinaturkiye.com"))
                                    {
