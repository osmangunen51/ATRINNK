            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new TrinnkException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (TrinnkException)
                {

                }
            }
            throw new TrinnkException("No contructor was found that had all the dependencies satisfied.");
        }
