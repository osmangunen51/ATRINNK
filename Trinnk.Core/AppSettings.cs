...
namespace Trinnk.Core
{
    public class AppSettings
    {
        ...
        public static string TrinnkWebUrl
        {
            get { return ConfigurationManager.AppSettings["TrinnkWebUrl"].ToString(); }
        }

        public static string TrinnkAdminUrl
        {
            get { return ConfigurationManager.AppSettings["TrinnkAdminUrl"].ToString(); }
        }
