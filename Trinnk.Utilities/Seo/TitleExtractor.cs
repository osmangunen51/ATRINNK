...
namespace Trinnk.Utilities.Seo
{
    ...
    public static class TitleExtractor
    {
        ...
        private static Regex regtitle = new Regex(@"(?<=(\s|^))"
                                                             + @"[A-Z\.0-9\\-ıIçÇüÜğĞöÖşŞöÖşŞ\\.\-][A-Za-z0-9\\-ıIçÇüÜğĞöÖşŞ\\.\-]*?[\.\-]*[A-Za-z0-9\\-ıIçÇüÜğĞöÖşŞ\\.\-]+?"
                                                             + @"((\s[a-z]{1,3}){0,2}\s[A-Z\.0-9\\-ıIçÇüÜğĞöÖşŞ\\.\-][A-Za-z0-9\\-ıIçÇüÜğĞöÖşŞ\\.\-]*?[\.\-]*[A-Za-z0-9\\-ıIçÇüÜğĞöÖşŞ\\.\-]+?){1,4}"
