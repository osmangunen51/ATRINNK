    ...
    public class ApiAuthorize : AuthorizeAttribute
    {
        ...
        private bool Authorize(HttpActionContext actionContext)
        {
            try
            {
                ...
                Trinnk.Api.View.LoginInfoFromToken Token = Newtonsoft.Json.JsonConvert.DeserializeObject<Trinnk.Api.View.LoginInfoFromToken>(TxtToken.Coz(TokenSifreKey));
