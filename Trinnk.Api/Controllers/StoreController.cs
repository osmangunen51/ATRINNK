using Trinnk.Api.ExtentionsMethod;
...
using Trinnk.Utilities.FileHelpers;
using Trinnk.Utilities.FormatHelpers;
...
using static Trinnk.Api.View.StoreCategoryItemModel;
...
namespace Trinnk.Api.Controllers
{
    public class StoreController : BaseApiController
    {
        ...
        public HttpResponseMessage GetWorkingTime(int MainPartyId)
        {
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        Trinnk.Api.View.StoreWorkingTime StoreWorkingTime = new Trinnk.Api.View.StoreWorkingTime()
                        {
                            MainPartyId = store.MainPartyId
                        };
        ...
        public HttpResponseMessage AddUpdateWorkingTime(Trinnk.Api.View.StoreWorkingTime Model)
        {
            if (Model.IsAllDays)
            {
                    ...
                    if (loginmember != null)
                    {
                        ...
                        if (store != null)
                        {
                            ...
                            if (phone != null)
                            {
                                ...
                                {
                                    memberSetting = new Trinnk.Entities.Tables.Settings.MemberSetting();
                    ...
                    if (store != null)
                    {
                        ...
                        StoreVideo StoreVideo = new StoreVideo()
                        {
                            ...
                            List = videos.Select(item => new StoreVideoItem()
                            {
                                ...
                                VideoPath = Trinnk.Utilities.VideoHelpers.VideoHelper.GetVideoPath(item.VideoPath).Replace("//", ""),
                            ...
                            foreach (var item in Model.List)
                            {
                                foreach (var model in Model.List)
                                {
                                    ...
                                    if (IslemDurum)
                                    {
                                        ...
                                        var video = new Trinnk.Entities.Tables.Videos.Video()
                                        {
                                            Active = true,
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        Trinnk.Api.View.StoreCertificate StoreCertificate = new Trinnk.Api.View.StoreCertificate()
                        {
                            MainPartyId = store.MainPartyId,
        ...
        public HttpResponseMessage DeleteCertificate(Trinnk.Api.View.StoreCertificate Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
        ...
        public HttpResponseMessage AddCertificate(Trinnk.Api.View.StoreCertificate Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
                ...
                try
                {
                    ...
                    if (loginmember != null)
                    {
                        ...
                        if (store != null)
                        {
                            ...
                            foreach (var model in Model.List)
                            {
                                var storeCertificate = new Trinnk.Entities.Tables.Stores.StoreCertificate();
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        Trinnk.Api.View.StoreCatalog StoreCatalog = new Trinnk.Api.View.StoreCatalog()
                        {
                            MainPartyId = store.MainPartyId,
        ...
        public HttpResponseMessage DeleteCatalog(Trinnk.Api.View.StoreCatalog Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
        ...
        public HttpResponseMessage AddCatalog(Trinnk.Api.View.StoreCatalog Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
                ...
                try
                {
                    ...
                    if (loginmember != null)
                    {
                        ...
                        if (store != null)
                        {
                            foreach (var model in Model.List)
                            {
                                var storeCatologFile = new Trinnk.Entities.Tables.Stores.StoreCatologFile();
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        Trinnk.Api.View.StorePermissionUser StorePermissionUser = new Trinnk.Api.View.StorePermissionUser()
                        {
                            MainPartyId = store.MainPartyId,
        ...
        public HttpResponseMessage AddPermissionUser(Trinnk.Api.View.StorePermissionUser Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
                ...
                try
                {
                    ...
                    if (loginmember != null)
                    {
                        ...
                        if (store != null)
                        {
                            foreach (var model in Model.List)
                            {
                                var mainParty = new Trinnk.Entities.Tables.Members.MainParty
                                {
                                    Active = false,
                                ...
                                var member = new Trinnk.Entities.Tables.Members.Member();
                                ...
                                var memberStore = new Trinnk.Entities.Tables.Members.MemberStore();
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        foreach (var item in qlist)
                        {
                            ...
                            if (address != null)
                            {
                                ...
                                if (address != null)
                                {
                                    ...
                                    var tel1 = Phones.Where(x => x.PhoneType == (byte)PhoneType.Phone).ToList().Take(1).FirstOrDefault();
                        ...
                        Trinnk.Api.View.StoreDealer StoreDealer = new Trinnk.Api.View.StoreDealer()
                        {
                            MainPartyId = store.MainPartyId,
        ...
        [HttpPost]
        public HttpResponseMessage DeleteDealer(Trinnk.Api.View.StoreDealerDelete Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
        ...
        public HttpResponseMessage AddUpdateDealer(Trinnk.Api.View.StoreDealer Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
                    ...
                    if (loginmember != null)
                    {
                        ...
                        if (store != null)
                        {
                            foreach (var model in Model.List)
                            {
                                DealerTypeEnum Type = (DealerTypeEnum)model.DealerType;
                                var qlist = _storeDealerService.GetStoreDealersByMainPartyId(store.MainPartyId, Type).ToList();
                                Trinnk.Entities.Tables.Stores.StoreDealer dealer = qlist.FirstOrDefault(x => x.StoreDealerId == model.DealerId);
                                if (dealer == null)
                                {
                                ...
                                if (address == null)
                                {
                                    address = new Trinnk.Entities.Tables.Common.Address
                                    {
                                        MainPartyId = null,
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        Trinnk.Api.View.StoreSector StoreSector = new Trinnk.Api.View.StoreSector()
                        {
                            MainPartyId = store.MainPartyId,
        ...
        public HttpResponseMessage AddUpdateSector(Trinnk.Api.View.StoreSector Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
                        ...
                        if (store != null)
                        {
...

                            {
                                if (item.SectorId == 0)
                                {
                                    if (item.IsSelected)
                                    {
                                        Trinnk.Entities.Tables.Stores.StoreSector StoreSectorCategory = new Trinnk.Entities.Tables.Stores.StoreSector()
                                        {
                                            CategoryId = item.CategoryId,
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        Trinnk.Api.View.StoreActivity StoreActivity = new Trinnk.Api.View.StoreActivity()
                        {
                            MainPartyId = store.MainPartyId,
        ...
        public HttpResponseMessage AddUpdateActivity(Trinnk.Api.View.StoreActivity Model)
        {
            ProcessResult processStatus = new ProcessResult();
            using (System.Transactions.TransactionScope Transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeOption.Required, TimeSpan.FromMinutes(30)))
            {
            ...
            try
            {
                ...
                if (loginmember != null)
                {
                    ...
                    if (store != null)
                    {
                        ...
                        var StoreBrand = new Trinnk.Entities.Tables.Stores.StoreBrand()
                        {
        ...
        public HttpResponseMessage InsertUpdateDealerShip(StoreDealerShip Model)
        {
            ...
            try
            {
                ...
                if (store != null)
                {
                    ...
                    {
                        Trinnk.Entities.Tables.Stores.DealerBrand dealerBrand = _dealarBrandService.GetDealerBrandByDealerBrandId(Model.DealerBrandId);
                        if (dealerBrand != null)
                        {
        ...
        public HttpResponseMessage GetStoreDetailByMainPartyId(int MainPartyId)
        {
            ...
            try
            {
                ...
                //model.MapAddress = $"https://api.trinnk.com/map/{encodeaddress}";
