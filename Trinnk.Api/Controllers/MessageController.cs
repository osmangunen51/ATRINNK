...
namespace Trinnk.Api.Controllers
{
    public class MessageController : BaseApiController
    {
                    ...
                    if (member.MainPartyId != model.TargetMainPartyId)
                    {
                        ...
                        else
                        {
                            ...
                            if (model.ProductId != 0)
                            {
                                ...
                                string loginauto = "https://www.trinnk.com/MemberShip/LogonAuto?validateId=" + encValue + "&returnUrl=" + messageLink;
        ...
        public HttpResponseMessage GetMessages()
        {
            ...
            try
            {
                ...
                if (member != null)
                {
                    ...
                    List<Trinnk.Entities.Tables.Catalog.Product> ProductList = new List<Trinnk.Entities.Tables.Catalog.Product>();
                    List<Trinnk.Entities.Tables.Members.Member> MemberList = new List<Entities.Tables.Members.Member>();
                    List<Trinnk.Entities.Tables.Messages.Message> MessageListesi = new List<Entities.Tables.Messages.Message>();
                    ...
                    ProductList = new List<Trinnk.Entities.Tables.Catalog.Product>();
        ...
        {
            Trinnk.Entities.Tables.Messages.Message MMessage = _messageService.GetMessageByMesssageId(MainMessage.MessageId);
