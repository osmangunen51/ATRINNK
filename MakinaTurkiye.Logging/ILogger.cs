...
namespace MakinaTurkiye.Logging
{
    public interface ILogger
    {
        ...
        /// <summary>
        ///   Determines if messages of priority "critical" will be logged.
        /// </summary>
        /// <value>True if "critical" messages will be logged.</value>
        ...
        /// <param name = "format">Format string for the message to log</param>
        /// <param name = "args">Format arguments for the message to log</param>
        void WarnFormat(string format, params string[] args);
        ...
        /// <summary>
        ///   Logs a critical message with lazily constructed message. The message will be constructed only if the <see cref = "IsCriticalEnabled" /> is true.
        /// </summary>
        void Critical(Func<string> messageFactory);
        ...
        /// <param name = "format">Format string for the message to log</param>
        /// <param name = "args">Format arguments for the message to log</param>
        void CriticalFormat(string format, params string[] args);
        ...
        /// <param name = "format">Format string for the message to log</param>
        /// <param name = "args">Format arguments for the message to log</param>
        void CriticalFormat(Exception exception, string format, params object[] args);
        ...
        /// <param name = "format">Format string for the message to log</param>
        /// <param name = "args">Format arguments for the message to log</param>
        void CriticalFormat(Exception exception, IFormatProvider formatProvider, string format, params object[] args);
    }
}
