...
{
    public static class MostViewProductResultExtensions
    {
        public static string GetCurrencyCssName(this MostViewProductResult product)
        {
        ...
        public static string GetFormattedPrice(this MostViewProductResult product)
        {
