using Trinnk.Pinterest.Model.Input.PinCreate;
using System;
using System.Collections.Generic;
using System.Net;
using System.Threading;

namespace Trinnk.Pinterest
{
    public class Istemci : IDisposable
    {
        ...
        public ProcessStatus Login()
        {
            ...
            try
            {
                ...
                Trinnk.Pinterest.Model.Input.User.UserSessionResourceCreate UserSessionResourceCreate = new Trinnk.Pinterest.Model.Input.User.UserSessionResourceCreate();
                ...
                if (!string.IsNullOrEmpty(IstekSonuc))
                {
                    ...
                    {
                        Trinnk.Pinterest.Model.Result.User.UserSessionResourceCreate Value = Newtonsoft.Json.JsonConvert.DeserializeObject<Trinnk.Pinterest.Model.Result.User.UserSessionResourceCreate>(IstekSonuc);
        ...
        public ProcessStatus CreatePin(string ImageUrl, string BoardID, string Description, string Link, string Title, string SectionID = "")
        {
            ...
            try
            {
                ...
                Trinnk.Pinterest.Model.Input.PinCreate.PinCreate PinCreate = new Trinnk.Pinterest.Model.Input.PinCreate.PinCreate();
                ...
                if (!string.IsNullOrEmpty(IstekSonuc))
                {
                    if (string.IsNullOrEmpty(IstekSonuc) | IstekSonuc.Contains(IstekKontrolIfadesi))
                    {
                        Trinnk.Pinterest.Model.Result.PinCreate.PinCreate Value = Newtonsoft.Json.JsonConvert.DeserializeObject<Trinnk.Pinterest.Model.Result.PinCreate.PinCreate>(IstekSonuc);
                        Result.Message = "İşlem Başarılı";
                        Result.Status = true;
                        Result.Tip = ProcessStatus.ProcessType.Success;
                        Result.Value = Value;
        ...
        public ProcessStatus ChangeBussines(string business_id, string owner_id)
        {
            ...
            try
            {
                ...
                string RequestUrl = $"";
                RequestUrl = $"{BaseUrl}resource/UserSessionResource/create/";
                Trinnk.Pinterest.Model.Input.ChangeBussines.ChangeBussines ChangeBussines = new Trinnk.Pinterest.Model.Input.ChangeBussines.ChangeBussines()
                {
        ...
        public ProcessStatus CreateBoard(string name, string description, string privacy = "public", bool collaborator_invites_enabled = false, bool no_fetch_context_on_resource = false, string source_url = "")
        {
            ...
            try
            {
                ...
                Trinnk.Pinterest.Model.Input.BoardCreate.BoardCreate BoardCreate = new Trinnk.Pinterest.Model.Input.BoardCreate.BoardCreate();
                ...
                if (!string.IsNullOrEmpty(IstekSonuc))
                {
                    if (string.IsNullOrEmpty(IstekSonuc) | IstekSonuc.Contains(IstekKontrolIfadesi))
                    {
                        Trinnk.Pinterest.Model.Result.BoardCreate.BoardCreate Value = Newtonsoft.Json.JsonConvert.DeserializeObject<Trinnk.Pinterest.Model.Result.BoardCreate.BoardCreate>(IstekSonuc);
                        if (Value != null)
                        {
                            Result.Message = "İşlem Başarılı";
                            Result.Status = true;
        ...
        public ProcessStatus ArchiveBoard(string boardId, bool no_fetch_context_on_resource = false, string source_url = "")
        {
            ...
            try
            {
                ...
                Trinnk.Pinterest.Model.Input.BoardArchive.BoardArchive BoardArchive = new Trinnk.Pinterest.Model.Input.BoardArchive.BoardArchive();
        ...
        public ProcessStatus DeletePin(string Id, bool no_fetch_context_on_resource = false, string source_url = "")
        {
            ...
            try
            {
                ...
                Trinnk.Pinterest.Model.Input.PinDelete.PinDelete PinDelete = new Trinnk.Pinterest.Model.Input.PinDelete.PinDelete();
