...
; (function ($) {
  $.contextMenu = {
    ...
    create: function (menu, opts) {
      ...
      $('body').live('contextmenu', function () { cmenu.hide(); }); // If right-clicked somewhere else in the document, hide this menu
      return cmenu;
    },
    ...
    createMenu: function (menu, cmenu) {
      ...
      var $t = $('<table cellspacing=0 cellpadding=0></table>').live('click', function () { cmenu.hide(); return false; }); // We wrap a table around it so width can be flexible
      var $tr = $('<tr></tr>');
      var $td = $('<td></td>');
