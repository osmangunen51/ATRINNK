...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ICollection<MakinaTurkiye.Entities.Tables.Common.AddressChangeHistory>>" %>
    ...
    <script type="text/javascript">
        function DeletePost(changeId) {
            if (confirm('Kaydı Silmek istediğinizden eminmisiniz ?')) {
                $.ajax({
                    url: '/ChangeLogs/addressChangeHistoryDelete',
                    data: { id: changeId },
                    type: 'post',
                    dataType: 'json',
      ...
      <thead>
        ...
        <td class="Header" style="width:5%">
          ...
          <td class="Header" style="width: 8%;">
            ...
            <tbody>
                <%=Html.RenderHtmlPartial("AddressList",Model) %>
          <tr>
  <td class="ui-state ui-state-default" colspan="8" align="right" style="border-color: #DDD;
	 ...
	 <div style="float: right;" class="pagination">
       ...
       { %>
			 ...
			 <% else
       { %>
			 <a href="/ChangeLogs/address?page=<%:i %>">
				<%: i%></a>&nbsp;
			 <% } %>
		  </li>
		  <% } %>
