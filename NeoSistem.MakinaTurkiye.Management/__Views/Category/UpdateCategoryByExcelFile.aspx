...
Kategorileri Excel Dosyası İle Güncelle
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%if (ViewBag.Updated != null && ViewBag.Updated == true) {%>
        <p style="font-size:15px; color:#003317">Ürünler başarıyla güncellenmiştir.</p>
    <% } %>
      <%using (Html.BeginForm("UpdateCategoryByExcelFile","Category",FormMethod.Post,new {@enctype="multipart/form-data" }))
          { %>
        <table border="0" class="tableForm" cellpadding="5" cellspacing="0">
      <tr>
    <td valign="top">
     Kategori Excel Dosyası
    </td>
    <td valign="top">
      :
    </td>
