...
<%   
  ...
  string InstitutionalWGSMAreaCode = "";
  string InstitutionalWGSMCulture = "";
  string InstitutionalWGSMNumber = "";
  ...
  var wgsmItem = Model.SingleOrDefault(c => c.PhoneType == (byte)PhoneType.Whatsapp);
  if (wgsmItem != null)
  {
      InstitutionalWGSMAreaCode = wgsmItem.PhoneAreaCode;
      InstitutionalWGSMCulture = wgsmItem.PhoneCulture;
      InstitutionalWGSMNumber = wgsmItem.PhoneNumber;
  }
...
%><table>
  <tr>
    <td colspan="2">
      <div style="width: 508px; height: 35px; margin-top: 5px; margin-left: 10px">
        <div style="width: 70px; height: 25px; text-align: left; float: left;">
  ...
  <tr>
    <td colspan="2">
      <div style="width: 508px; height: 35px; margin-top: 5px; margin-left: 10px;">
        <div style="width: 70px; height: 25px; text-align: right; float: left;">
  ...
  <tr>
    <td colspan="2">
      <div style="width: 508px; height: 35px; margin-top: 5px; margin-left: 10px;">
        ...
        <div style="width: auto; height: auto; float: left; margin-left: 3px;">
         ...
         <%--   <input type="checkbox" name="GsmWhatsapp" />Gsm Whatsapp olarak tanımla--%>
        </div>
      </div>
    </td>
  </tr>
    ...
    <td colspan="2">
      <div style="width: 508px; height: 35px; margin-top: 5px; margin-left: 10px;">
        <div style="width: 70px; height: 25px; text-align: right; float: left;">
          <span style="font-size: 12px; color: #4c4c4c">Whatsapp Gsm</span> :
        </div>
        <div style="width: auto; height: auto; float: left; margin-left: 7px;">
          <input type="text" name="InstitutionalWGSMCulture" id="InstitutionalWGSMCulture" value="<%:InstitutionalWGSMCulture  %>"
            class="small_input" style="width: 30px; height: 17px; padding-top: 3px; font-size: 12px;" />
        </div>
        <div style="width: auto; height: auto; float: left; margin-left: 5px;">
          <div style="width: auto; height: 23px; float: left; border: #c9e6e2 1px solid; border-top: #c9e6e2 2px solid">
            <select style="height: 18px; font-size: 11px; border: none; margin: 2px;" id="InstitutionalWGSMAreaCode"
              name="InstitutionalWGSMAreaCode">
              <option value="0">Seç</option>
        ...
        <div style="width: auto; height: auto; float: left; margin-left: 3px;">
          <input type="text" name="InstitutionalWGsmNumber" id="InstitutionalWGsmNumber" value="<%:InstitutionalWGSMNumber  %>"
            class="small_input" style="width: 75px; height: 17px; padding-top: 3px; font-size: 12px;" />
           
            <%if (wgsmItem != null && wgsmItem.WhatsappActive == false)
                              {
                    %>
         
            <%:Html.CheckBox("WhatsappConfirm", false) %> Firma Onayı
                <%}
                              else {%>
                <%:Html.Hidden("WhatsappConfirm",true) %>
            <% }%>
