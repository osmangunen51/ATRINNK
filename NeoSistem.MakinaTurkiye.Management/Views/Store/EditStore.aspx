    ...
    <div style="float: left; margin: 20px 0px 0px 10px">
        ...
        <div style="width: 520px; float: left;">
            ...
            <table border="0" cellpadding="5" cellspacing="0" style="margin-left: 20px;">
                ...
                <tr>
                    <td style="width: 150px;">Tekil Görüntülenme
                    </td>
                    <td>:
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 150px;">Görüntülenme
                    </td>
                    <td>:
                    </td>
                    <td>
          ...
          <td>
            ...
            <span style="width: 30px;" onmouseup="tıkla()">&nbsp;<%: Html.RadioButton("StoreActiveType", "3", onaylanmadi)%>&nbsp;&nbsp;Onaylanmadı
            </span>
