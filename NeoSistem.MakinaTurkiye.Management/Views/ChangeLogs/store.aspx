<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<FilterModel<global::MakinaTurkiye.Entities.Tables.Stores.StoreChangeHistory>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table cellpadding="13" cellspacing="0" class="TableList" style="width: 100%; margin-top: 5px">
        <thead>
            <tr>
                <td class="Header HeaderBegin" style="width: 5%;">Mağaza No
                </td>

                <td class="Header" style="width: 12%;">Mağaza Adı
                </td>
                <td class="Header" style="width: 4%;">Logo
                </td>
                <td class="Header" style="width: 5%;" unselectable="on">Mağaza Durumu
                </td>
                <td class="Header" style="width: 10%;" unselectable="on">Web Adresi
                </td>
