<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<NeoSistem.MakinaTurkiye.Management.Models.Entities.MemberDescription>>" %>

   <% int row = 0; %>
<% foreach (var item in Model)
   { %>
<% row++; %>
<tr id="row<%: item.descId%>" class="<%: (row % 2 == 0 ? "Row" : "RowAlternate") %>">
