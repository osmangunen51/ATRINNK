...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <%using (Html.BeginForm("Edit", "Packet", FormMethod.Post, new { enctype = "multipart/form-data" }))
    {%>
  <div style="width: 1000px; height: auto; float: left; margin-left: 20px; margin-top: 20px;
    padding-bottom: 30px;">
    <%------------------------------------Paket Genel Bilgileri------------------------------------%>
    <div style="float: left; width: 100%; margin-left: 10px;">
      <div style="border: dashed 2px #bababa; width: 428px; height: auto; float: left;
        padding-bottom: 10px; margin-top: 10px;">
        <div style="float: left; margin-left: 2%; margin-top: 5px; width: 96%; border-bottom: dashed 1px #bababa;
          padding-bottom: 3px;">
    ...
    <div style="border: solid 1px #bababa; width: 300px; height: auto; float: left; padding-bottom: 10px;
      ...
      <div style="float: left; width: 275px; border: dashed 1px #bababa; margin-left: 10px;
        margin-top: 10px;">
        <div style="float: left; width: 100%;">
          <div style="width: 10%; float: left; height: 26px; border-right: dashed 1px #bababa;
            border-bottom: dashed 1px #bababa; text-align: center; padding-top: 4px;">
          ...
          <div id="divNumber<%:item.PacketFeatureTypeId %>" style="width: 89%; float: left;
            height: 30px; border-bottom: dashed 1px #bababa;">
            <div style="float: left; margin-top: 6px; margin-left: 5px;">
              Sayı Kısıtlaması :
            </div>
            <div style="float: left; margin-top: 4px; margin-left: 5px;">
              <input id="txtNumber<%:item.PacketFeatureTypeId %>" type="text" style="height: 15px;
                width: 50px;" onkeyup="setValues('txtNumber<%:item.PacketFeatureTypeId %>','hdn<%:item.PacketFeatureTypeId %>','1',<%:item.PacketFeatureTypeId %>)"
        ...
        <div style="float: left; width: 100%;">
          ...
          <div id="divActive<%:item.PacketFeatureTypeId %>" style="width: 89%; float: left;
            height: 30px; border-bottom: dashed 1px #bababa;">
            <div style="float: left; margin-top: 6px; margin-left: 5px;">
              Aktif :
            </div>
        ...
        <div style="float: left; width: 100%;">
          ...
          <div id="divContent<%:item.PacketFeatureTypeId %>" style="width: 89%; float: left;
            height: 30px;">
            <div style="float: left; margin-top: 6px; margin-left: 5px;">
              İçerik Yazısı :
            </div>
            <div style="float: left; margin-top: 4px; margin-left: 5px;">
              <input id="chkContent<%:item.PacketFeatureTypeId %>" type="text" style="height: 15px;
                width: 100px;" onkeyup="setValues('chkContent<%:item.PacketFeatureTypeId %>','hdn<%:item.PacketFeatureTypeId %>','3',<%:item.PacketFeatureTypeId %>)"
