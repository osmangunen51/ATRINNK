    ...
    public class ProductController : BaseController
    {
        ...
        public ActionResult Edit(int id, ProductModel model, FormCollection coll, string productPriceType)
        {
            ...
            if (Request.Files.AllKeys.Contains("NewProductPicture") && Request.Files["NewProductPicture"].ContentLength > 0)
            {
                ...
                NeoSistem.MakinaTurkiye.Management.Helper.ProductImageHelpers productImageHelpers = new NeoSistem.MakinaTurkiye.Management.Helper.ProductImageHelpers(AppSettings.ProductImageFolder, thumbSizes);
            ...
            if (model.IsAdvanceEdit)
            {
                ...
                var topCategories = new List<global::MakinaTurkiye.Entities.StoredProcedures.Catalog.TopCategoryResult>();
            ...
            if (model.IsAdvanceEdit != true)
            {
                if (Session["ProductStatu"].ToByte() == 0)
                {
                    ...
                    try
                    {
                        ...
                        mail.Subject = "MakinaTurkiye.com Bilgilendirme-" + ilanonay;                                              //Mail konusu
            ...
            {
                productHomePage = new global::MakinaTurkiye.Entities.Tables.Catalog.ProductHomePage();
        ...
        private void PrepareHomeSectorProductList(IList<global::MakinaTurkiye.Entities.Tables.Catalog.ProductHomePage> productHomePages, List<HomeSectorProductItem> source)
        {
        ...
        {
            var certificateType = new global::MakinaTurkiye.Entities.Tables.Catalog.CertificateType();
