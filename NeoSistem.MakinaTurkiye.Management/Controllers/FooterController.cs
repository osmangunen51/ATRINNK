...
namespace NeoSistem.MakinaTurkiye.Management.Controllers
{
    public class FooterController : BaseController
    {
        ...
        public ActionResult FooterContents(int? page, int? id)
        {
            ...
            skipRows = page == null || page == 0 ? 0 : (int)(page - 1) * pageSize;
            ViewData["page"] = page == null ? 0 : (int)page;
            IEnumerable<global::MakinaTurkiye.Entities.Tables.Content.FooterContent> footerContents;
            if (id == null)
        ...
        {
            var footerContent = new global::MakinaTurkiye.Entities.Tables.Content.FooterContent();
