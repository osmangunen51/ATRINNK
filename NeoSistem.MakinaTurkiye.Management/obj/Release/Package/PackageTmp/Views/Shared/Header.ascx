...
<div id="cs">
  <ul class="cstabs" unselectable="on">
    <li><a id="selected" unselectable="on" ondblclick="minimizeRibbon('tab-content');"
      class="tabMainHome" onclick="ribbonTabSlide('tabMainHome');" style="color: #FFF;
      background: url(/Content/RibbonImages/FileMenu_Background_blue.PNG) repeat-x;" group="tabs">Anasayfa</a>
    </li>
