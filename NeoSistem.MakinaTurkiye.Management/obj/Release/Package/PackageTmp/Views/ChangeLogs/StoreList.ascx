<%@ Control Language="C#" Inherits="NeoSistem.MakinaTurkiye.Core.Web.ViewUserControl<FilterModel<global::MakinaTurkiye.Entities.Tables.Stores.StoreChangeHistory>>" %>
<% int row = 0; %>
