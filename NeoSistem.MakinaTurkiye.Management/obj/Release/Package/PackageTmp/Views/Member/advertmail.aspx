...
<body>
   ...
   <%using (Html.BeginForm())
     {%>
            ...
            <ul style="list-style: none; float: left; padding: 0px; width: 300px; border: solid 1px #8fc0d1;
              ...
              <li style="float: left; width: 240px;">
                <div style="width: auto; float: left; height: auto;">
                  ...
                  <div style="width: auto; float: left; margin-left: 5px; font-size: 12px;
                    color: #000">
                    <%: item2.ConstantName%>
                  </div>
                </div>
          ...
          <div id="button3" style="float: right; margin-right: 270px;">
