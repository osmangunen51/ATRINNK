...
namespace NeoSistem.MakinaTurkiye.Management.Hubs
{
    ...
    public class System: Microsoft.AspNet.SignalR.Hub
    {
        ...
        {
            var connectionID = NeoSistem.MakinaTurkiye.Management.Hubs.UserList._UserList.FirstOrDefault(x => x.Key == userId.ToString()).Value;
