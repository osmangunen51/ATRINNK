...
{
    public class ElasticSearchCommonLogger : Microsoft.Extensions.Logging.ILogger
    {
        ...
        public ElasticSearchCommonLogger(string categoryName, Action<JObject> scribeProcessor)
        {
            ...
            _logLevel = Microsoft.Extensions.Logging.LogLevel.Trace;
        ...
        {
            return logLevel != Microsoft.Extensions.Logging.LogLevel.None && logLevel >= _logLevel;
        }
