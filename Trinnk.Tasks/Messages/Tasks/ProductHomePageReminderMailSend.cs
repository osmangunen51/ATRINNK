...
namespace Trinnk.Tasks.Messages.Tasks
{
    public class ProductHomePageReminderMailSend : IJob
    {
        public Task Execute(IJobExecutionContext context)
        {
            ...
            if (productHomePages.Count > 0)
            {
                ...
                MailHelper mailHelper = new MailHelper(title, mailContent, AppSettings.MailUserName, toEmail, AppSettings.MailPassword, "trinnk Sistem Mesajı", AppSettings.MailHost, AppSettings.MailPort, AppSettings.MailSsl);
