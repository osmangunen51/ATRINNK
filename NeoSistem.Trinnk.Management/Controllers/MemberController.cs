...
namespace NeoSistem.Trinnk.Management.Controllers
{
    ...
    using global::Trinnk.Services.Bulletins;
    using global::Trinnk.Services.Catalog;
    using global::Trinnk.Services.Checkouts;
    using global::Trinnk.Services.Common;
    using global::Trinnk.Services.Messages;
    using global::Trinnk.Utilities.FormatHelpers;
    using global::Trinnk.Utilities.HttpHelpers;
    using global::Trinnk.Utilities.MailHelpers;
    using Models;
    using NeoSistem.EnterpriseEntity.Business;
    using NeoSistem.Trinnk.Management.Models.MemberModels;
    using System.IO;
    using System.Web;
    ...
    public class MemberController : BaseController
    {
            ...
            else if (storeforsendmail.Count > 0 && storeforsendmail != null)
            {
                ...
                foreach (var singlemember in storeforsendmail)
                {
                    ...
                    try
                    {
                        ...
                        mail.From = new MailAddress("trinnk@trinnk.com", "Makina Türkiye"); //Mailin kimden gittiğini belirtiyoruz
        ...
        public ActionResult memberactivation(int id, string[] RelatedCategory)
        {
            ...
            if (mailadress.Active == false)
            {
                ...
                string actlink = "http://www.trinnk.com/" + "Uyelik/Aktivasyon/" + mailadress.ActivationCode;
        ...
        public ActionResult storemail(int id, string[] RelatedCategory, int tip, string mailcontent)
        {
            try
            {
                if (tip == 1 || tip == 2)
                {
                    ...
                    if (constatn.ConstantName.Contains("Paket Ödeme Hatırlatma"))
                    {
                        TempData["StoreEmailError"] = "Paket Ödeme Hatırlatma Maili Siparişler ekranından yapabilirsiniz.";
                    }
                    else
                    {
                        ...
                        var loginLink = "https://www.trinnk.com/membership/LogonAuto?validateId=" + crtypoUyeId;
                        ...
                        string packetupgrade = "http://www.trinnk.com/uyelikgiris?email=" + adress + "&pagetype=5";
                        if (urunler.Count != 0)
                        {
                        ...
                        string linkuyeliktipi = "https://www.trinnk.com/magaza-paket-fiyatlari-y-143135";
                        ...
                        MailMessage mail = new MailMessage();
                        string storefix = "http://www.trinnk.com/uyelikgiris?email=" + adress + "&pagetype=2";
                        ...
                        if (sayi == 144 || sayi == 145)
                        {
                            if (sayi == 144)
                            {
                                ...
                                sayi = 23;
                            string iskontoluyelik = "http://www.trinnk.com/uyelikgiris?email=" + adress + "&sifre=" + mailadress.MemberPassword + "&Packetid=" + sayi;
        ...
        public ActionResult stororderremembermail(int orderId)
        {
            ...
            try
            {
                ...
                res.IsSuccess = true;
                res.Message = "Başarıyla gönderildi.";
            }
            catch (Exception)
            {
                res.IsSuccess = false;
        ...
        public ActionResult SendSpecialEmailToStore(StoreSpecialMailModel model, HttpPostedFileBase[] files, string[] defaultFile, string FileSave)
        {
            ...
            string sablon = NeoSistem.Trinnk.Management.Properties.Resources.EmailSablon.ToString();
            ...
            MailMessage mail = new MailMessage();
            mail.From = new MailAddress("makina@trinnk.com"); //Mailin kimden gittiğini belirtiyoruz
            ...
            foreach (HttpPostedFileBase file in files)
            {
                ...
                if (file != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(FileSave))
                    {
                        ...
                        var constant = new global::Trinnk.Entities.Tables.Common.Constant();
        ...
        public ActionResult advertmail(int id, string[] RelatedCategory)
        {
            ...
            string urunlink = "http://www.trinnk.com/" + Helpers.ToUrl(groupname) + "/" + product.ProductId + "/" + Helpers.ToUrl(categoryname) + "/" + Helpers.ToUrl(product.ProductName);
            var mailadress = entities.Members.Where(c => c.MainPartyId == id).SingleOrDefault();
            string adress = mailadress.MemberEmail.ToString();
            string advertfix = "http://www.trinnk.com/uyelikgiris?email=" + adress + "&pagetype=" + product.ProductId;
            ...
            string linkuyeliktipi = "http://www.trinnk.com/Home/Prices";
        ...
        public JsonResult PhoneMailSend(int id)
        {
            ...
            string actLink = "http://trinnk.com/uyelik/sifreolustur/" + member.ActivationCode;
            ...
            if (messageErrors.ToList().Count > 0)//gönderilmeyen tüm mailleri gönder
            {
                foreach (var messageItem in messageErrors)
                {
                    using (TransactionUI tran = new TransactionUI())
                    {
                        ...
                        var message = new global::Trinnk.Entities.Tables.Messages.Message
                        {
                            Active = true,
                        ...
                        var messageMainParty = new global::Trinnk.Entities.Tables.Messages.MessageMainParty
                        {
                        ...
                        var curMessageMainParty = new global::Trinnk.Entities.Tables.Messages.MessageMainParty
                        {
                        ...
                        if (messageItem.ProductID != 0)
                        {
                            ...
                            string productUrl = "http://www.trinnk.com" + NeoSistem.Trinnk.Core.Web.Helpers.Helpers.ProductUrl(product.ProductId, productName);
        ...
        public void ActivationCodeSend(string Email, string activationCode, string memberNameSurname)
        {
            ...
            mail.To.Add(Email);
            mail.Subject = mailMessage.MessagesMTTitle;
            string actLink = "http://trinnk.com/Uyelik/Aktivasyon/" + activationCode;
            string template = mailMessage.MessagesMTPropertie;
      ...
      new { controller = "Member", action = "BrowseDesc", id = ids }));
        ...
        {
            var memberDescriptionLog = new global::Trinnk.Entities.Tables.Members.MemberDescriptionLog();
        ...
        {
            var members = new List<global::Trinnk.Entities.Tables.Bullettins.BulletinMember>();
            int totalRecord = 0;
            int pageSize = 50;
        ...
        public JsonResult GetCreateMailForm(int id, string[] RelatedCategory)
        {
            ...
            try
            {
                ...
                {
                    res.IsSuccess = false;
                    res.Message = "Paket Ödeme Hatırlatma Maili Siparişler ekranından yapabilirsiniz.";
                }
                else
                {
                    string allusersubtitle = subtitle;
