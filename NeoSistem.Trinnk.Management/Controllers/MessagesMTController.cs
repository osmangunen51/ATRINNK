namespace NeoSistem.Trinnk.Management.Controllers
{
    ...
    public class MessagesMTController : BaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            return View(new NeoSistem.Trinnk.Management.Models.Entities.MessagesMT());

        }

        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Create(NeoSistem.Trinnk.Management.Models.Entities.MessagesMT model)
        {
            TrinnkEntities entities = new TrinnkEntities();
            var packet = new NeoSistem.Trinnk.Management.Models.Entities.MessagesMT
            {
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult EditConstants(int id, NeoSistem.Trinnk.Management.Models.Entities.MessagesMT model)
        {
            TrinnkEntities entities = new TrinnkEntities();
