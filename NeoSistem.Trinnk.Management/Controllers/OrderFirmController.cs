...
using NeoSistem.Trinnk.Management.Models.ViewModel;
using System;
...
namespace NeoSistem.Trinnk.Management.Controllers
{
    public class OrderFirmController : BaseController
    {
        ...
        {
            TrinnkEntities olsutur = new TrinnkEntities();
        ...
        public ActionResult Confirm(int id)
        {
            ...
            if (order.PriceCheck == true)
            {
                ...
                var newPayment1 = new global::Trinnk.Entities.Tables.Checkouts.Payment();
      ...
      "<p>" + store.StoreName + "</p>\r\n\r\n" + "<p>Telefon:0212-255-71-50</p><br/> <img src=\"http://trinnk.com/Content/Images/logo.png \"/ alt=\"Makina Türkiye\"/><br/><a href=\"http://www.trinnk.com\" >www.trinnk.com</a><span></body></html>";
        ...
        {
            var newPayment = new global::Trinnk.Entities.Tables.Checkouts.Payment();
        ...
        public ActionResult GetInvoice(int OrderId)
        {
            ...
            if (order != null)
            {
                var entities1 = new TrinnkEntities();
        ...
        {
            global::Trinnk.Entities.Tables.Checkouts.Order addOrderModel = new global::Trinnk.Entities.Tables.Checkouts.Order();
            var store = _storeService.GetStoreByMainPartyId(order.MainPartyId);
        ...
        {
            using (var _entities = new TrinnkEntities())
            {
        ...
        public ActionResult OrderWriteLogs(int? page)
        {
            ...
            var _entities = new TrinnkEntities();
        ...
        {
            using (var _entitites = new TrinnkEntities())
            {
        ...
        public ActionResult UpdatePayDate(UpdatePayDateModel model)
        {
            ...
            else
            {
                ...
                {
                    var memberDesc = new global::Trinnk.Entities.Tables.Members.MemberDescription();
        ...
        private void PreparePaymentModel(PaymentModel model)
        {
            ...
            model.PayUrl = "https://www.trinnk.com/membership/LogonAuto?validateId=" + link;
        ...
        public JsonResult ReturnAmountAdd(string orderId, string amount, string billdate)
        {
            try
            {
                var order = _orderService.GetOrderByOrderId(Convert.ToInt32(orderId));
                _orderService.UpdateOrder(order);
                var returnInvoice = new global::Trinnk.Entities.Tables.Checkouts.ReturnInvoice();
        ...
        public List<OrderReportItemModel> PrepareReportList(IList<global::Trinnk.Entities.StoredProcedures.Orders.OrderReportResultModel> reports)
        {
