...
using global::Trinnk.Services.Checkouts;
...
using NeoSistem.Trinnk.Management.Models.Orders;
using NeoSistem.Trinnk.Management.Models.Stores;
...
using AdressExtenstionNew = global::Trinnk.Entities.Tables.Common.AddressExtensions;
    ...
    public class StoreController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            foreach (var item in collection)
            {
                ...
                item.LogingLink = "https://www.trinnk.com/membership/LogonAuto?validateId=" + link + "&returnUrl=/account/advert/advert";
        ...
        public ActionResult ExportStores(StoreModel model, string OrderName, string Order, int? Page, int PageDimension, byte? PacketStatus)
        {
            ...
            {
                var link = lHelper.Encrypt(item.MemberMainPartyId.ToString());
                string logingLink = "https://www.trinnk.com/membership/LogonAuto?validateId=" + link + "&returnUrl=/account/Store/UpdateStore";
        ...
        private string PhoneNumberToString(global::Trinnk.Entities.Tables.Common.Phone phone)
        {
            if (phone != null)
            {
                string phSplitter = "_";
                        ...
                        if (sheet.GetRow(row) != null) //null is when the row only contains empty cells   
                        {
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(gsm) && gsm.IndexOf(phSplitter) > 0)
                                {
                                    ...
                                    var gsmNewPhone = new global::Trinnk.Entities.Tables.Common.Phone
                                    {
                                        active = 1,
                                ...
                                if (!string.IsNullOrEmpty(phone1) && phone1.IndexOf(phSplitter) > 0)
                                {
                                    ...
                                    var phoneNew1 = new global::Trinnk.Entities.Tables.Common.Phone
                                    {
                                        active = 1,
                                        MainPartyId = store.MainPartyId,
                                ...
                                if (!string.IsNullOrEmpty(phone2) && phone2.IndexOf(phSplitter) > 0)
                                {
                                    ...
                                    var phoneNew2 = new global::Trinnk.Entities.Tables.Common.Phone
                                    {
                                        active = 1,
                                        MainPartyId = store.MainPartyId,
                                ...
                                if (!string.IsNullOrEmpty(whatsappGsm) && whatsappGsm.IndexOf(phSplitter) > 0)
                                {
                                    ...
                                    var whatsappNew = new global::Trinnk.Entities.Tables.Common.Phone
                                    {
                                        active = 1,
                                        MainPartyId = store.MainPartyId,
        ...
        public ActionResult EditStore(int id)
        {
            ...
            ViewData["LoginId"] = "https://www.trinnk.com/membership/LogonAuto?validateId=" + link;
            ...
            if (tempPacketId != model.PacketId || tempStoreActiveType != model.StoreActiveType)
            {
                ...
                switch (StoreProductStatu)
                {
                    ...
                    case PacketStatu.Onaylanmadi:
                        ...
                        if (ps != "3")
                        {
                            ...
                            try
                            {
                                var settings = ConfigurationManager.AppSettings;
                                MailMessage mail = new MailMessage();
                                mail.From = new MailAddress("trinnk@trinnk.com", "Makina Turkiye"); //Mailin kimden gittiğini belirtiyoruz
                                mail.To.Add(member.MemberEmail);                                                              //Mailin kime gideceğini belirtiyoruz
                    ...
                    case PacketStatu.Silindi:
                        ...
                        "<p>" + store.StoreName + "</p>\r\n\r\n" +
                        "<p>Telefon:0212-255-71-50</p><br/> <img src=\"http://trinnk.com/Content/Images/logo.png \"/ alt=\"Makina Türkiye\"/><br/><a href=\"http://www.trinnk.com\" >www.trinnk.com</a><span></body></html>";
                                mail.Body = template;                                                            //Mailin içeriği
                                mail.IsBodyHtml = true;
                                mail.Priority = MailPriority.Normal;
                                this.SendMail(mail);
        ...
        public void ConvertExcel()
        {
            ...
            for (int i = 0; i < parcalidegerler.Length; i++)
            {
                ...
                try
                {
                    ...
                    string adres = NeoSistem.Trinnk.Management.Models.EnumModels.AddressEdit(address);
        ...
        public ActionResult LoginLogs(int? page)
        {
            ...
            var listeModel = new List<global::Trinnk.Entities.Tables.Logs.LoginLog>();
            ...
            FilterModel<global::Trinnk.Entities.Tables.Logs.LoginLog> model = new FilterModel<global::Trinnk.Entities.Tables.Logs.LoginLog>();
        ...
        public string UpdateStoreUrlName()
        {
            ...
            foreach (var item in stores)
            {
                if (item != null)
                {
                    ...
                    {
                        using (var entites1 = new TrinnkEntities())
                        {
        ...
        public ActionResult StoreDetailInformation(int id)
        {
            ...
            model.StoreInformationModel.StoreUrl = "https://www.trinnk.com/" + store.StoreUrlName;
      ...
      equals ms.StoreMainPartyId
        ...
        public ActionResult CreateNew(StoreNewItem model)
        {
            ...
            else
            {
                ...
                {
                    var storeNew = new global::Trinnk.Entities.Tables.Stores.StoreNew();
        ...
        public void ConfirmNewMail(global::Trinnk.Entities.Tables.Stores.StoreNew storeNew)
        {
            try
            {
        ...
        public JsonResult BuyPacket(BuyPacketModel model)
        {
            ...
            var order = new global::Trinnk.Entities.Tables.Checkouts.Order
            {
            ...
            if (model.DiscountType != "0")
            {
                var storeDiscount = new global::Trinnk.Entities.Tables.Stores.StoreDiscount();
            ...
            if (model.OrderType == (byte)Ordertype.HavaleTaksit)
            {
                ...
                foreach (var item in installmentsDates)
                {
                    ...
                    var orderInstallment = new global::Trinnk.Entities.Tables.Checkouts.OrderInstallment();
            ...
            var orderDescription = new global::Trinnk.Entities.Tables.Checkouts.OrderDescription();
            ...
            {
                sozlesmeLink = "https://www.trinnk.com/deneme-paketi-sozlesmesi-y-363195?storeId=" + store.MainPartyId + "&orderId=" + order.OrderId;
            }
            else
            {
                sozlesmeLink = "https://www.trinnk.com/satis-sozlesmesi-y-146659?storeId=" + store.MainPartyId + "&orderId=" + order.OrderId;
            }
            ...
            using (var entitites = new TrinnkEntities())
            {
            ...
            mailb.To.Add("trinnk@trinnk.com");
        ...
        public ActionResult StoreSector(StoreSectorModel model, int[] SectorCategoriesForm)
        {
            ...
            {
                var storeSector = new global::Trinnk.Entities.Tables.Stores.StoreSector();
        ...
        public string ExportStoreGsmPhones()
        {
            ...
            string filename = "trinnk-firma_telefon-listesi";
        ...
        public ActionResult DeleteStore(int storeMainPartyId)
        {
            ...
            var basePath = "C:/Web/s.trinnk.com";
            foreach (var item in stores)
            {
        ...
        public ActionResult StoreInfoChecked(int id)
        {
            ...
            if (storeUpdate == null)
            {
                storeUpdate = new global::Trinnk.Entities.Tables.Stores.StoreUpdated();
            ...
            try
            {
                ...
                if (MainPartyId > 0)
                {
                    ...
                    if (SendMail)
                    {
                        ...
                        var settings = ConfigurationManager.AppSettings;
                        MailMessage mail = new MailMessage();
                        global::Trinnk.Entities.Tables.Messages.MessagesMT mailT = _messageMtService.GetMessagesMTByMessageMTName("goldenpro");
        ...
        public  string GetFullAddress(global::Trinnk.Entities.Tables.Common.Address address)
        {
