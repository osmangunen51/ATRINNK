...
namespace NeoSistem.Trinnk.Management.Controllers
{
    public class MemberDescriptionController : BaseController
    {
        ...
        public ActionResult Notification(string UserId)
        {
            ...
            var memberDescs = new List<global::Trinnk.Entities.StoredProcedures.Members.MemberDescriptionForStore>();
        ...
        [HttpPost]
        public PartialViewResult Notification(int userId, string city,int fromUserId,string inputdate, string updateDate, int page, int userGroupId, int orderBy, int constantId)
        {
            int pageDimension = 30;
            var memberDescs = new List<global::Trinnk.Entities.StoredProcedures.Members.MemberDescriptionForStore>();
            int totalRecord = 0;
            memberDescs = _memberDescService.GetMemberDescByOnDate(userId, userGroupId, pageDimension, page, orderBy, constantId, out totalRecord, city, inputdate, updateDate, fromUserId).ToList();
        ...
        public List<NotificationModel> PrepareNotificationList(List<global::Trinnk.Entities.StoredProcedures.Members.MemberDescriptionForStore> memberDescs, int pageDimension)
        {
        ...
        public ActionResult AllTask()
        {
            ...
            FilterModel<global::Trinnk.Entities.StoredProcedures.Members.MemberDescriptionTaskItem> model = new FilterModel<global::Trinnk.Entities.StoredProcedures.Members.MemberDescriptionTaskItem>();
