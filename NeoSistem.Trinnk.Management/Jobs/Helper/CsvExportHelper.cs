...
namespace NeoSistem.Trinnk.Management.Helper
{
    ...
    public class CsvExportHelper
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Jitbit.Utils.CsvExportHelper"/> class.
        /// </summary>
        ...
        /// </param>
        public CsvExportHelper(string columnSeparator = ",", bool includeColumnSeparatorDefinitionPreamble = true)
        {
        ...
        public byte[] ExportToBytes()
        {
            ...
            byte[] utfBytes = utf8.GetBytes(Export());
            byte[] isoBytes = Encoding.Convert(utf8, iso, utfBytes);
            //var data = iso.GetString(isoBytes);
            return Encoding.UTF8.GetPreamble().Concat(isoBytes).ToArray();
        }
    }
}