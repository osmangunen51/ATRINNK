namespace NeoSistem.Trinnk.Management.Models
{
    ...
    public class MemberModel
    {
        ...
        public IEnumerable<NeoSistem.Trinnk.Management.Models.Entities.Category> SectorItems { get; set; }

        public IEnumerable<NeoSistem.Trinnk.Management.Models.Entities.Category> ParentItems(int CategoryId)
        {
        ...
        public IEnumerable<NeoSistem.Trinnk.Management.Models.Entities.Phone> PhoneItems { get; set; }
        public byte GsmType { get; set; }

        public NeoSistem.Trinnk.Management.Models.Entities.Address Address { get; set; }
    }
}