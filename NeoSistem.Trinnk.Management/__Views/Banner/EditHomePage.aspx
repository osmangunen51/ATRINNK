<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="NeoSistem.Trinnk.Core.Web.ViewPage<BannerModel>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function bannerslide(Bannerslideid) {
            if (Bannerslideid == 1) {
                $("#homepage").show("slow");
                $("#categoryside").hide("slow");
                $("#productside").hide("slow");
                $("#sliderside").hide("slow");
            }
            else if (Bannerslideid == 2) {
                $("#homepage").hide("slow");
                $("#categoryside").show("slow");
                $("#productside").hide("slow");
                $("#sliderside").hide("slow");
            }
            else if (Bannerslideid == 3) {
                $("#sliderside").hide("slow");
                $("#homepage").hide("slow");
                $("#categoryside").hide("slow");
                $("#productside").show("slow");
            }
            else if (Bannerslideid == 4) {
                $("#homepage").hide("slow");
                $("#categoryside").hide("slow");
                $("#productside").hide("slow");
                $("#sliderside").show("slow");
            }
        }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data) {
                                ...
                                window.location = "/Banner/EditHomePage";
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <% using (Html.BeginForm("EditHomePage", "Banner", FormMethod.Post, new { enctype = "multipart/form-data" })) { %>
    <%=Html.HiddenFor(c => c.BannerType, new { id = "hdnBannerType" })%>
    <%=Html.HiddenFor(c => c.SaveMessage, new { id = "hdnSaveMessage" })%>
    <div style="width: 845px; height: 50px; float: left; margin-left: 20px; margin-top: 20px;">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="bannerslide(4)">Slider Banner</a>
        <a onclick="bannerslide(1)">anasayfa reklamları</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="bannerslide(2)">kategori reklamları</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="bannerslide(3)">Ürün reklamları</a>
  

    </div>
        <div id="sliderside" style="width: 100%; height: auto; float: left; margin-left: 20px; margin-top: 20px; ">
        <% using (Html.BeginForm("EditHomePage", "Banner", FormMethod.Post, new { enctype = "multipart/form-data" })) { %>
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            ...
            <div style="width: 100%; float: left; margin-top: 10px;">
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%= Html.FileUploadFor(c => c.Banner7Rsc, new { style = "border: none; width: 250px; height: 22px; border: solid 1px #bababa" })%>
                    </div>
                </div>
            </div>
            ...
            <div style="width: 100%; float: left; margin-top: 5px;">
                ...
                <div style="width: 90%; float: left;">
                    <%=Html.TextBox("Banner7Order","", new { style = "width: 244px;" })%>
                </div>
            </div>
            ...
            <div style="width: 100%; float: left; margin-top: 5px;">
                ...
                <div style="width: 90%; float: left;">
                    <div style="float: left;">
                        <%=Html.TextBox("Banner7Link","", new { style = "width: 244px;" })%>
                    </div>
        ...
        <% } %>
        <%var banner7 = Model.BannerItems.Where(c => c.BannerType == (byte)BannerType.MainSlider);%>
            <div style="float:left">
        <% foreach (var item in banner7) {
        %>
        <div style="width: 600px; border: dashed 1px #bababa; height: 332px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                ...
                <div style="width: 90%; float: left;"> 
                    <div style="width: auto; float: left;">
                        <a href="<%:item.BannerLink %>">
                            <img src="<%:AppSettings.BannerImagesThumbFolder+ item.BannerResource %>"  width="330px" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div style="width: 100%; float: left; margin-top: 5px;">
                ...
                <div style="width: 90%; float: left;">
                    <div style="float: left;">
                        <label><%:item.BannerLink != null ? item.BannerLink.ToString() : ""%></label>
                    </div>
                    <div style="float: right;">
                        <button onclick="DeleteBanner(<%:item.BannerId%>);" type="button">
                            Sil</button>
                    </div>
                </div>
            </div>
    ...
    <div id="homepage" style="width: 845px; height: auto; float: left; margin-left: 20px; margin-top: 20px; display: none;">
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                <span style="font-weight: bold; font-size: 14px">Anasayfa Sağ Banner</span>
            </div>
            <div style="width: 100%; float: left; margin-top: 10px;">
                <div style="width: 10%; float: left;">
                    Dosya
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%var banner1 = Model.BannerItems.SingleOrDefault(c => c.BannerType == (byte)BannerType.MainPageRight);%>
                ...
                <div style="width: 90%; float: left;">
                    ...
                    <div style="float: right;">
                        <button onclick="DeleteBanner(<%:banner1 != null ? banner1.BannerId: 0 %>);" type="button">
                            Sil</button>
                        <button onclick="$('#hdnBannerType').val('<%:(byte)BannerType.MainPageRight %>');$('#hdnSaveMessage').val('true');">
                            Kaydet</button>
                    </div>
                </div>
            </div>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="height: 100%;">
                <tr>
                    <td align="center" valign="middle">
                        ...
                        <% } else {%>
                        <a href="<%:banner1.BannerLink %>">
                            <img style="width: 170px; height: 150px" src="<%:AppSettings.BannerImagesThumbFolder+ banner1.BannerResource %>" /></a>
                        <% } %>
                        <% } %>
          </td>
                </tr>
        ...
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                <span style="font-weight: bold; font-size: 14px">Anasayfa Alt Sol Banner</span>
            </div>
            <div style="width: 100%; float: left; margin-top: 10px;">
                <div style="width: 10%; float: left;">
                    Dosya
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%var banner2 = Model.BannerItems.SingleOrDefault(c => c.BannerType == (byte)BannerType.MainPageBottom1);%>
                ...
                <div style="width: 90%; float: left;">
                    ...
                    <div style="float: right;">
                        <button onclick="DeleteBanner(<%:banner2 != null ? banner2.BannerId: 0 %>);" type="button">
                            Sil</button>
                        <button onclick="$('#hdnBannerType').val('<%:(byte)BannerType.MainPageBottom1 %>');$('#hdnSaveMessage').val('true');">
                            Kaydet</button>
                    </div>
                </div>
            </div>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="height: 100%;">
                <tr>
                    <td align="center" valign="middle">
                        ...
                        <% } else {%>
                        <a href="<%:banner2.BannerLink %>">
                            <img style="width: 100%" src="<%:AppSettings.BannerImagesThumbFolder+ banner2.BannerResource %>" /></a>
                        <% } %>
                        <% } %>
          </td>
                </tr>
        ...
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                <span style="font-weight: bold; font-size: 14px">Anasayfa Alt Orta Banner</span>
            </div>
            <div style="width: 100%; float: left; margin-top: 10px;">
                <div style="width: 10%; float: left;">
                    Dosya
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%var banner3 = Model.BannerItems.SingleOrDefault(c => c.BannerType == (byte)BannerType.MainPageBottom2);%>
                ...
                <div style="width: 90%; float: left;">
                    ...
                    <div style="float: right;">
                        <button onclick="DeleteBanner(<%:banner3 != null ? banner3.BannerId: 0 %>);" type="button">
                            Sil</button>
                        <button onclick="$('#hdnBannerType').val('<%:(byte)BannerType.MainPageBottom2 %>');$('#hdnSaveMessage').val('true');">
                            Kaydet</button>
                    </div>
                </div>
            </div>
        ...
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                <span style="font-weight: bold; font-size: 14px">Anasayfa Alt Sağ Banner</span>
            </div>
            <div style="width: 100%; float: left; margin-top: 10px;">
                <div style="width: 10%; float: left;">
                    Dosya
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%var banner4 = Model.BannerItems.SingleOrDefault(c => c.BannerType == (byte)BannerType.MainPageBottom3);%>
                ...
                <div style="width: 90%; float: left;">
                    ...
                    <div style="float: right;">
                        <button onclick="DeleteBanner(<%:banner4 != null ? banner4.BannerId: 0 %>);" type="button">
                            Sil</button>
                        <button onclick="$('#hdnBannerType').val('<%:(byte)BannerType.MainPageBottom3 %>');$('#hdnSaveMessage').val('true');">
                            Kaydet</button>
                    </div>
                </div>
            </div>
    ...
    <div id="categoryside" style="width: 840px; height: auto; float: left; margin-left: 20px; margin-top: 20px; display: none;">
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                <span style="font-weight: bold; font-size: 14px">Kategori Sol Alt Banner</span>
            </div>
            <div style="width: 100%; float: left; margin-top: 10px;">
                <div style="width: 10%; float: left;">
                    Dosya
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%var banner5 = Model.BannerItems.SingleOrDefault(c => c.BannerType == (byte)BannerType.CategorySideLeft);%>
                        <%= Html.FileUploadFor(c => c.Banner5Rsc, new { style = "border: none; width: 250px; height: 22px; border: solid 1px #bababa" })%>
                    </div>
                </div>
            </div>
            <div style="width: 100%; float: left; margin-top: 5px;">
                ...
                <div style="width: 90%; float: left;">
                    ...
                    <div style="float: right;">
                        <button onclick="DeleteBanner(<%:banner5 != null ? banner5.BannerId: 0 %>);" type="button">
                            Sil</button>
                        <button onclick="$('#hdnBannerType').val('<%:(byte)BannerType.CategorySideLeft %>');$('#hdnSaveMessage').val('true');">
                            Kaydet</button>
                    </div>
                </div>
            </div>
    ...
    <div id="productside" style="width: 840px; height: auto; float: left; margin-left: 20px; margin-top: 20px; display: none;">
        <div style="float: left; width: 600px; float: left; border: dashed 1px #bababa; height: 132px; padding: 10px;">
            <div style="width: 98%; height: auto; border-bottom: dashed 1px #bababa; padding: 5px;">
                <span style="font-weight: bold; font-size: 14px">Ürün Sol Banner</span>
            </div>
            <div style="width: 100%; float: left; margin-top: 10px;">
                <div style="width: 10%; float: left;">
                    Dosya
                ...
                <div style="width: 90%; float: left;">
                    <div style="width: auto; float: left;">
                        <%var banner6 = Model.BannerItems.SingleOrDefault(c => c.BannerType == (byte)BannerType.ProductSideLeft);%>
