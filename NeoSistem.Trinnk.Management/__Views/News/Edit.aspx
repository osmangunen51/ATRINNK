<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="NeoSistem.Trinnk.Core.Web.ViewPage<NewsModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <table border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
      ...
      <td>
        <img src="<%: Model.ThumbPicture %>" alt="Alternate Text" width="100" height="100" />
