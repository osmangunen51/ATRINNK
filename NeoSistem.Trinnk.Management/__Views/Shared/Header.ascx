<%@ Control Language="C#" Inherits="NeoSistem.Trinnk.Core.Web.ViewUserControl" %>
...
<div id="cs">
    ...
    <table style="float:right;top:1px;position:absolute;right:10px">
        <tr>
            ...
            <td>
                <a class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="padding: 2px;" href="/MemberDescription/Notification?UserId=<%:NeoSistem.Trinnk.Management.Models.Authentication.CurrentUserModel.CurrentManagement.UserId%>" title="Bildirimler" id="notification1"></a>
            </td>
            <td>
    ...
    font-weight: 600;" href="/Help/Show" title="Yardım">Yardım</a>
        ...
        <a class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="padding: 2px;background: #3d6bcd;color:white;padding: 6px;" href="/Account/Logout">
            <%= NeoSistem.Trinnk.Management.Models.Authentication.CurrentUserModel.CurrentManagement.UserName%> | Çıkış Yap</a>
            </td>
        </tr>
    </table>
