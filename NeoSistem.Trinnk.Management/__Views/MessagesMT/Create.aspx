<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<NeoSistem.Trinnk.Management.Models.Entities.MessagesMT>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <input id="activeText" type="hidden" value="" />
   <%using (Html.BeginForm("Create", "MessagesMT", FormMethod.Post, new { enctype = "multipart/form-data" }))
    {%>
