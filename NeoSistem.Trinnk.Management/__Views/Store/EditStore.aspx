...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#IsProductAdded').click(function () {
                if ($('#IsProductAdded').is(':checked') == false) {
                    alert("Veri girişi tamamlanmış olarak kayıt edilecek.");

                }
                else {
                    alert("Veri girişi tamamlanmamış olarak kayıt edilecek.");
                }
            });
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <table>
            <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><%:Html.TextBoxFor(m=>m.TaxOffice,new {@style="width:100px;"}) %>/<%:Html.TextBoxFor(m=>m.TaxNumber,new {@style="width:100px;"}) %></td>
                </tr>
                <tr>

                    <td><%:Html.LabelFor(x=>x.MersisNo) %>/<%:Html.LabelFor(x=>x.TradeRegistrNo) %></td>
                    <td>:</td>
                    <td><%:Html.TextBoxFor(m=>m.MersisNo,new {@style="width:100px;"}) %>/<%:Html.TextBoxFor(m=>m.TradeRegistrNo,new {@style="width:100px;"}) %></td>
                </tr>
            </table>
                </td>
                <td style="width:30%; vertical-align:top">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <img src="<%:logoThumb %>" style="border: solid 1px #b6b6b6; width: 300px;" />
                        <% }
                            else
                            {
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <%:Html.TextBoxFor(x => x.SeoTitle,new {@style="width:400px"}) %>
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="width: 150px;">
                ...
                <tr>
                    <td valign="top" style="width: 150px;">Hızlı Giriş Link
                    </td>
                    <td valign="top">:
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    <td valign="top" style="width: 150px;">Ödeme Sayfası Linki
                    </td>
                    <td valign="top">:
                    </td>
                ...
                <tr>
                    <td>Veri Girişi Tamamlandı</td>
                    <td>:</td>

                    <td>

                        <%:Html.CheckBox("IsProductAdded",Model.IsProductAdded.HasValue ? Model.IsProductAdded.Value:false ) %>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <ul style="list-style:none;padding:0px;margin:0px">
                           <li style="display:inline-table">
                                <%: Html.RadioButton("StoreActiveType", "1", inceleniyor)%>İnceleniyor
                            </li>
                           <li style="display:inline-table">
                                <%: Html.RadioButton("StoreActiveType", "2", onaylandi)%>Onaylandı
                                <span style="width: 30px;" onmouseup="tıkla()">
                            </li>
                             <li style="display:inline-table">
                                <%: Html.RadioButton("StoreActiveType", "3", onaylanmadi)%>Onaylanmadı
                            </li>
                           <li style="display:inline-table">
                                <%: Html.RadioButton("StoreActiveType", "4", silindi)%>Silindi
                            </li>
                        </ul>
 ...
 <tr>
                    <td style="width: 150px;">Firma Çoğul Görüntülenme
                    </td>
                    <td>:
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 150px;">Firma Tekil Görüntülenme
                    </td>
                    <td>:
                    </td>
                    <td>
    ...
    <script type="text/javascript">
        ...
        %>
            $("#statisticproduct").load("/Store/Statistic/<%=mainpartyid%>", function () {
