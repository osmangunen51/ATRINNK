<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<NeoSistem.Trinnk.Management.Models.Stores.StoreNewItem>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="float: left; width: 800px; margin-top: 10px;">
        <%using (Html.BeginForm("EditNew","Store", FormMethod.Post,new {@enctype="multipart/form-data" }))
            { %>
        ...
        <table border="0" class="tableForm" cellpadding="5" cellspacing="0">
            ...
            <tr>
                <td></td>
                <td></td>
                <td><%:Html.CheckBoxFor(x=>x.Active) %> Onayla</td>
            </tr>
