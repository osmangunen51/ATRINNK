...
<script type="text/javascript">
  function DealerAddForService() {
    $.ajax({
      url: '/Store/DealerAddForService',
      type: 'post',
      dataType: 'json',
      data: { DealerNameForService: $('#DealerNameForService').val(), storeId: $('#storeId').val() },
...
<div style="width: 500px; float: left;">
  <div style="width: auto; height: auto; margin-top: 20px; margin-left: 20px">
    <div style="font-size: 13px; font-weight: bold; margin-left: 50px; width: 700px">
      Yetkili Servis ve iletişim bilgilerini ekleyiniz.
    </div>
    <div style="float: left; height: auto; width: 700px; margin-top: 15px;">
      ...
      <div style="float: left; margin-left: 4px;">
        <div class="textBig">
          <%= Html.TextBox("DealerNameForService")%>
        </div>
      </div>
      <div style="float: left; margin-left: 5px;">
        <button type="button" onclick="DealerAddForService();">
          Ekle</button>
      </div>
    </div>
  </div>
  <div style="width: 400px; height: auto; float: left; margin-top: 10px;">
    ...
    <div style="float: left;">
      <div class="dropdownAddress">
        <%:Html.DropDownList("StoreDealerId", Model.DealerItemsForService, new { style = "width : 203px; height: 18px; font-size: 11px; border: none; margin: 1px; margin-right: 2px;" })%></div>
    </div>
  </div>
  <div style="float: left;">
...
<div style="float: left; margin-left: 100px; width: 300px; margin-top: 80px">
  <div style="float: left; width: 300px; height: 30px;">
    <span style="font-size: 13px; font-weight: bold;">Yetkili Servisler ve Adresleri</span>
  </div>
