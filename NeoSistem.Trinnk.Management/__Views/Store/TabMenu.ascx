...
<div style="float: left; width: 100%; height: auto; float: left;">
    ...
    <div style="float: left;">
        ...
        <div class="<%:tab %> anotherback">
            <% NeoSistem.Trinnk.Management.Controllers.LinkHelper lHelper = new NeoSistem.Trinnk.Management.Controllers.LinkHelper();
        ...
        <div style="background-color:#4cb4e5" class="<%:tab %> mailback">
            <a href="/Member/storemail/<%=mainpartyid%>" id="lightbox_click" rel="superbox[iframe][1000x600]">Mailing </a>
        </div>
