...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    <style type="text/css">
        .small_input { width: 120px; font-size: 12px; padding-left: 5px; }
        .big_input { width: 180px; font-size: 12px; padding-left: 5px; }
        .btnSave { background-image: url('/Content/Images/btnSave.gif'); width: 70px; height: 24px; border: none; cursor: pointer; }
        .btnAdd { background-image: url('/Content/Images/btnAdd.gif'); width: 55px; height: 24px; border: none; cursor: pointer; }
        .fileUpload { font-size: 12px; width: 180px; height: 20px; border: solid 1px #bababa; }
        .profileBg { width: 967px; height: auto; background-image: url('/Content/Images/profileBg.gif'); border: solid 1px #cbdfed; float: left; background-repeat: repeat-x; padding-bottom: 15px; }
        .profileStartLink { color: #727679; text-decoration: underline; font-size: 12px; }
            .profileStartLink:hover { color: #727679; font-size: 12px; text-decoration: underline; }
            .profileStartLink:visited { color: #727679; text-decoration: underline; font-size: 12px; }
        .speedStep { width: 900px; height: 100px; margin-left: 33px; margin-top: 60px; }
        .speedStepContent { width: auto; height: auto; float: left; margin-left: 250px; font-size: 12px; font-weight: bold; text-align: center; }
        .accordionHeader { background-image: url('/Content/Images/profilePanelBg.gif'); border-bottom: solid 1px #aebecd; }
        .dropdownBig { width: 216px; height: 20px; border: solid 1px #bababa; }
            .dropdownBig select { width: 216px; height: 20px; }

        .textBig { width: 204px; height: 18px; border: solid 1px #bababa; padding-left: 12px; background-color: #fff; padding-top: 2px; }
            .textBig input { width: 190px; background-color: transparent; border: none; }

        .textBigArea { width: 204px; height: 58px; border: solid 1px #bababa; padding-left: 12px; background-color: #fff; padding-top: 4px; }
            .textBigArea textarea { width: 200px; height: 50px; background-color: transparent; border: none; }

        .textMedium { width: 64px; height: 18px; border: solid 1px #bababa; padding-left: 12px; background-color: #fff; padding-top: 2px; float: left; }
            .textMedium input { width: 50px; background-color: transparent; border: none; }

        .textSmall { width: 30px; height: 18px; border: solid 1px #bababa; padding-left: 2px; background-color: #fff; padding-top: 2px; float: left; }
            .textSmall input { width: 24px; background-color: transparent; border: none; }
    </style>
    ...
    <style type="text/css">
        ...
        .accordionButton { width: 780px; float: left; border: 1px solid #d3d3d3; cursor: pointer; height: 25px; color: #000; font-size: 13px; padding-left: 20px; padding-top: 5px; }

        .accordionContent { width: 800px; float: left; display: none; border: 1px solid #d3d3d3; background-color: #ccc; }
    </style>
    <script type="text/javascript" src="/Scripts/CKEditor/ckeditor.js"></script>
    <script type="text/javascript" src="/Scripts/CKFinder/ckfinder.js"></script>
        ...
        <tr>
            <td>
                <div id="tabs" style="margin: 0px;">
                    <ul>
                        <li class="tabLi" style="display: none;"><a class="tabStore" href="#tabs-1" ref="nothing">Mağaza Bilgileri</a></li>
                        <li class="tabLi" style="display: none;"><a class="tabStore" href="#tabs-2" ref="nothing">Üyelik Bilgileri</a></li>
                        <li class="tabLi" style="display: none;"><a class="tabStore" href="#tabs-3" ref="divIletisimAddressForm">İletişim Bilgileri</a></li>
                        <li class="tabLi" style="display: none;"><a class="tabStore" href="#tabs-4" ref="nothing">Faaliyet Tipleri</a></li>
                        <li class="tabLi" style="display: none;"><a class="tabStore" href="#tabs-5" ref="nothing">Faaliyet Alanları</a></li>
                    </ul>
                        ...
                        <div style="width: 520px; float: left;">
                            <table border="0" cellpadding="5" cellspacing="0" style="margin-left: 20px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%: Html.TextBox("StorePacketBeginDate", Model.StorePacketBeginDate.Value.ToString("dd.MM.yyyy") != "01.01.0001" ? Model.StorePacketBeginDate.Value.ToString("dd.MM.yyyy") : "", new { style = "width: 94px;" })%>
                  </td>
                                    <td></td>
                                </tr>
                                <tr>
                    ...
                    &nbsp;<%: Html.RadioButton("PacketStatu", "3", silindi)%>&nbsp;&nbsp;Silindi
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div style="margin: 20px auto; padding-top: 10px; border-top: solid 1px #DDD; width: 99%; float: left">
                                            <button type="submit">
                                                Kaydet</button>
                                            <button type="reset">
                                                İptal</button>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <% if (!String.IsNullOrEmpty(Model.StoreLogo))
                                            { %>
                                        <% if (FileHelpers.HasFile("/UserFiles/Images/StoreLogo/" + Model.StoreLogo))
                                            { %>
                                        <img id="imageLogo" height="100" src="/UserFiles/Images/StoreLogo/<%= Model.StoreLogo %>"
                ...
                +90&nbsp;<%:item.PhoneAreaCode%>&nbsp;<%:item.PhoneNumber%><br />
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td></td>
                                <td valign="top" style="height: 20px; width: 100px;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="height: 30px;">
                                    <div id="divAddressType" class="dropdownAddress">
                                        <%:Html.DropDownListFor(model => model.AddressTypeId, Model.AddressTypeItems, new { @class = "small_input", style = "width : 203px; height: 18px; font-size: 11px; margin: 1px; margin-right: 2px;" })%>
                                    </div>
                                </td>
                            </tr>
                            <%   var dataAddress = new NeoSistem.Trinnk.Data.Address(); %>
                            <tr>
                                <td align="right" style="padding-right: 6px;">
                                ...
                                <td style="height: 30px;">
                                    <div id="divCountryId" class="dropdownAddress">
                                        <%:Html.DropDownListFor(model => model.CountryId, Model.CountryItems, new { @class = "small_input", style = "width : 203px; height: 18px; font-size: 11px; margin: 1px; margin-right: 2px;" })%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="height: 30px;">
                                    <div id="divCityId" class="dropdownAddress">
                                        <%:Html.DropDownListFor(model => model.CityId, Model.CityItems, new { @class = "small_input", style = "width : 203px; height: 18px; font-size: 11px; margin: 1px; margin-right: 2px;" })%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div id="tabs-4">
                        <div style="width: 390px; height: 170px; border: solid 1px #b0afaf; padding-left: 20px; padding-top: 25px;">
                            ...
                            <div style="width: 130px; height: 25px; margin-top: 10px; float: left;">
                                ...
                                <div style="float: left; width: auto; height: auto; float: left; margin-left: 4px; margin-top: 4px;">
                                </div>
                                <%:item.ActivityName%>
                            </div>
                            <% } %>
                    ...
                    <div id="tabs-5">
                        <div style="width: 570px; height: auto; float: left;">
                            ...
                            <div style="width: 400px; float: left; margin-left: 10px;">
                                <div style="width: 14px; height: 14px; background-image: url('/Content/Images/plus.png'); float: left; cursor: pointer;"
                                    id="plus<%: item.CategoryId %>" onclick="openContent('#plusContent<%: item.CategoryId %>');">
                                </div>
                                <div style="width: 250px; min-height: 27px; margin-left: 10px; float: left;">
                                    ...
                                    <br />
                                    <div id="plusContent<%: item.CategoryId %>" style="width: 375px; min-height: 27px; margin-left: 10px; float: left; display: none;"
                                        class="plusContent">
                                        <ul style="list-style: none; float: left; padding: 0px; width: 730px; border: solid 1px #8fc0d1; padding-top: 10px; padding-bottom: 10px; padding-left: 10px; background-color: #f8fbff;">
