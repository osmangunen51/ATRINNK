<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="NeoSistem.Trinnk.Core.Web.ViewPage<FilterModel<StoreModel>>" %>
                ...
                <tr>
                  <td style="width: 100%;">
                    <select id="PacketId" name="PacketId" onchange="SearchPost();" style="width: 100%">
                      ...
                      <% foreach (var item in new TrinnkEntities().Packets)
                         { %>
