<%@ Control Language="C#" Inherits="NeoSistem.Trinnk.Core.Web.ViewUserControl<FilterModel<global::Trinnk.Entities.StoredProcedures.Stores.StoreChangeInfoResult>>" %>
<% int row = 0; %>
