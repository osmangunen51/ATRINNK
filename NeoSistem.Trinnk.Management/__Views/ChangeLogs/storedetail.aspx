<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Trinnk.Entities.Tables.Stores.StoreChangeHistory>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <table border="0" cellpadding="5" cellspacing="0" style="margin-left: 20px;">
            ...
            <tr>
                <td style="width: 150px;">Firma İsmi
                </td>
                <td>:
                </td>
                <td>
                ...
                <td><%if (Model.StoreName != Model.Store.StoreName)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreUniqueShortName != Model.Store.StoreUniqueShortName)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreWeb != Model.Store.StoreWeb)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            ...
            <tr>
                ...
                <td><%if (Model.StoreEMail != Model.Store.StoreEMail)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreCapital != Model.Store.StoreCapital)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreEstablishmentDate != Model.Store.StoreEstablishmentDate)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreType != Model.Store.StoreType)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreEmployeesCount != Model.Store.StoreEmployeesCount)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreEndorsement != Model.Store.StoreEndorsement)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            ...
            <tr>
                ...
                <td><%if (Model.TaxNumber != Model.Store.TaxNumber)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.MersisNo != Model.Store.MersisNo)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
            <tr>
                ...
                <td><%if (Model.StoreAbout != Model.Store.StoreAbout)
                        {%>
                    <p>Değiştirildi</p>
                    <% } %></td>
            </tr>
