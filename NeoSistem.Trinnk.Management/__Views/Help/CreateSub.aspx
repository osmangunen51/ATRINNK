<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<NeoSistem.Trinnk.Management.Models.Entities.HelpSubcategory>" %>
        ...
        <h3>YARDIM ALTKATEGORİSİ EKLE</h3>
          ...
          margin-bottom: 10px;">
            ...
            <div class="editor-field">
                ...
                <%= Html.DropDownListFor(model=>model.YKID, new SelectList((IEnumerable)ViewData["Kategori"],"YKID","KategoriAd","Seçiniz")) %>
