<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<NeoSistem.Trinnk.Management.Models.WebSiteErrorListItem>>" %>
...
<tr id="row<%:item.WebSiteErrorId %>">
    ...
    <% }
        else
        {
            ...
            {
    %>
    <td class="Cell">İncelendi / Bekliyor</td>
    <%
        }
        else { 
    %>
