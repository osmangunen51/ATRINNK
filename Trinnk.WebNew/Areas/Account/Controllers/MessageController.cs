...
using NoeSistemHelpers = NeoSistem.Trinnk.Core.Web.Helpers.Helpers;
    ...
    public class MessageController : BaseAccountController
    {
        ...
        public ActionResult Index(MessageViewModel model)
        {
            ...
            if (receiverUser.FastMemberShipType == (byte)FastMembershipType.Phone)
            {
                ...
                //    string productUrl = "http://www.trinnk.com/" + Helpers.ToUrl(groupname) + "/" + product.ProductId + "/" + Helpers.ToUrl(categoryname) + "/" + Helpers.ToUrl(productName);
                ...
                //    sc.Credentials = new NetworkCredential("trinnk@trinnk.com", "haciosman7777"); //Gmail hesap kontrolü için bilgilerimizi girdi
                //    sc.Send(mail);
                //}
                //    #endregion
