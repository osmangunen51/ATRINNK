...
using NeoSistem.Trinnk.Web.Models.AccountModels;
...
namespace NeoSistem.Trinnk.Web.Areas.Account.Controllers
{
    ...
    public class HomeController : BaseAccountController
    {
        ...
        public ActionResult Index(string gelenSayfa, string memberType)
        {
            ...
            var store1 = new global::Trinnk.Entities.Tables.Stores.Store();
                ...
                foreach (var messageItem in messageErrors)
                {
                    using (TransactionUI tran = new TransactionUI())
                    {
                        ...
                        if (messageItem.ProductID != 0)
                        {
                            ...
                            string productUrl = "http://www.trinnk.com" + Core.Web.Helpers.Helpers.ProductUrl(product.ProductId, productName);
                            try
                            {
