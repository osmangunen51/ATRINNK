...
using NeoSistem.Trinnk.Web.Areas.Account.Models.StoreImage;
using NeoSistem.Trinnk.Web.Areas.Account.Models.Stores;
using NeoSistem.Trinnk.Web.Areas.Account.Models.Stores.StoresViewModel;
...
namespace NeoSistem.Trinnk.Web.Areas.Account.Controllers
{
    public class StoreController : BaseAccountController
    {
        ...
        public ActionResult UpdateActivity(string[] StoreActivityCategory)
        {
            if (StoreActivityCategory != null)
            {
                ...
                for (int i = 0; i < StoreActivityCategory.Length; i++)
                {
                    ...
                    {
                        var storeActivityType = new global::Trinnk.Entities.Tables.Stores.StoreActivityCategory
                        {
            ...
            else
            {
                ...
                else
                {
                    foreach (var file in model.CreateCatologForm.FilePaths)
                    {
                        ...
                        var storeCatologFile = new global::Trinnk.Entities.Tables.Stores.StoreCatologFile();
        ...
        public MTSettingItemModel PrepareMTSettingItemModel(global::Trinnk.Entities.Tables.Common.Phone phone, int storeMainPartyId)
        {
