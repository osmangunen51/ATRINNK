...
function selectStoreSearch() {
    $(".navbar-form").attr("action", "https://www.trinnk.com/Sirketler?SearchType=3&amp;");
}

/*Listeden Ürün Ara Seç*/
function selectProductSearch() {
    $(".navbar-form").attr("action", "https://www.trinnk.com/kelime-arama?CategoryId=0");
}

function selectVideoSearch() {
    $(".navbar-form").attr("action", "https://www.trinnk.com/Videolar/AramaSonuclari?CategoryId=0");
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data == true) {
                ...
                window.location.href = 'https://www.trinnk.com/Uyelik/kullanicigirisi';
            }
        },
        error: function (x, l, e) {
            $("#FavoriteProductLoading").hide();
...
function SendMessageforpro(messagetype) {
    ...
    var obj = new Object();
    obj.redirect = 'https://www.trinnk.com/Account/Message/Index?MessagePageType=1&UyeNo=' + memberNo + '&UrunNo=' + productNo;
    $.ajax({
        url: 'https://www.trinnk.com/ajax/IsAuthenticate',
        data: obj,
        type:'get',
        success: function (data) {
            if (data == true) {
                ...
                window.location.href = 'https://www.trinnk.com/Account/Message/Index?MessagePageType=1&UyeNo=' + memberNo + '&UrunNo=' + productNo;
...
function cookiePolicyInit() {
    $('body').cookieDisclaimer({
        ...
        text: "<i class='fa fa-info-circle'></i> Hizmetlerimizden en iyi şekilde faydalanabilmeniz için çerezler kullanıyoruz. trinnk.com'u kullanarak çerezlere izin vermiş olursunuz. <a href='/cerez-politikasi-y-183318'>Çerez politikamız için tıklayın.</a>",
        acceptBtn: {
