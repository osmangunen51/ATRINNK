var POLICY_LINK = "https://www.trinnk.com/cerez-politikasi-y-183318";
var COOKIE_NAME = "hideCookiePolicy";
var COOKIE_CSS_PATH ="/Content/V2/assets/css/cookiePolicy.css";
var createCookiePolicy = {
    

    text: "<span class='text-wrapper'><i class='fa fa-info-circle'></i> Hizmetlerimizden en iyi şekilde faydalanabilmeniz için çerezler kullanıyoruz.<br> trinnk.com'u kullanarak çerezlere izin vermiş olursunuz. <a href='"+POLICY_LINK+"'>Çerez politikamız için tıklayın.</a></span>",
    createDiv : function() {
...
function setCookie(cname, cvalue) {
    ...
    document.cookie = cname + "=" + cvalue + ";" + expires + ";domain=.trinnk.com;path=/";
}
