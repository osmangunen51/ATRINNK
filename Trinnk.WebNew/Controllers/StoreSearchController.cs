...
namespace NeoSistem.Trinnk.Web.Controllers
{
    ...
    public class StoreSearchController : Controller
    {
        ...
        public JsonResult SearchCategory(string categoryName)
        {
            ...
            {
                IList<NeoSistem.Trinnk.Web.Models.Entities.Category> categoryItems = null;
                List<SelectListItem> categoryList = new List<SelectListItem>();

                using (Trinnk.Web.Models.Entities.TrinnkEntities entities = new Trinnk.Web.Models.Entities.TrinnkEntities())
                {
                    byte MainCategory = (byte)MainCategoryTypeEnum.MainCategory;
                    categoryItems = entities.spCategoryGetCategoryByCategoryName(categoryName).Where(c => c.MainCategoryType == MainCategory).ToList<NeoSistem.Trinnk.Web.Models.Entities.Category>();
                }
