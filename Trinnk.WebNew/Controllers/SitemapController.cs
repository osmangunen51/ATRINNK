...
namespace NeoSistem.Trinnk.Web.Controllers
{
    ...
    using NeoSistem.Trinnk.Core.Sitemap;
    ...
    {
        private const string URL = "https://www.trinnk.com/";
        private const string PRODUCT_URL = "https://www.trinnk.com/";
        private const string VIDEO_URL = "https://video.trinnk.com/";
        private const string STORE_URL = "https://magaza.trinnk.com/";
            ...
            for (int i = 0; i < (productTotalCount / slice) + 1; i++)
            {
                ...
                if (isAdded == false)
                {
                    var smn1 = new SitemapNode
                    {
                        ...
                        location = "https://www.trinnk.com/urun-kategori-c-0",
                        priority = 0.9f
                    };
                    sm.items.Add(smn1);
                    isAdded = true;
        ...
        protected string generateSitemap_StoreCategory()
        {
            ...
            writer.WriteElementString("loc", "https://magaza.trinnk.com");
            // start:optional
            ...
            {
                string link = "https://magaza.trinnk.com/";
                writer.WriteStartElement("url");
        ...
        protected string generateSitemap_video()
        {
            ...
            foreach (var item in videos)
            {
                writer.WriteStartElement("url");
                // required
                string link = "https://video.trinnk.com/" + Helpers.ToUrl(item.ProductName) + "-v-" + item.VideoId;
                writer.WriteElementString("loc", link);
                ...
                writer.WriteElementString("video", "thumbnail_loc", null, "https://www.trinnk.com/UserFiles/VideoThumb/" + item.VideoPicturePath);
                //writer.WriteElementString("video", "family_friendly", null, "Yes");
                writer.WriteElementString("video", "content_loc", null, "https://www.trinnk.com/UserFiles/Video/" + item.VideoPath + ".flv");
                ...
                //writer.WriteString("https://www.trinnk.com/embeddedplayer.swf");
        ...
        protected string generateSitemap_videocategory()
        {
            ...
            writer.WriteStartElement("url");
            // required
            string urlBase = "https://video.trinnk.com";
            ...
            foreach (var item in categories)
            {
                writer.WriteStartElement("url");
                // required
                string link = "https://video.trinnk.com/" + Helpers.ToUrl(item.CategoryName) + "-videolari-vc-" + item.CategoryId;
                writer.WriteElementString("loc", link);
                // start:optional
                writer.WriteElementString("priority", "0.8");
                writer.WriteEndElement(); //url
        ...
        protected string generateSitemap_categorysector()
        {
            ...
            categories.Add(new global::Trinnk.Entities.StoredProcedures.Catalog.SiteMapCategoryResult
            {
                BrandName = "",
        ...
        protected string generateSitemap_categorybrand()
        {
            ...
            var path = Server.MapPath("/sitemaps/" + fileName);
            var writer = new XmlTextWriter(path, Encoding.UTF8);
            const string url = "https://www.trinnk.com/";
            XNamespace ns = "http://www.sitemaps.org/schemas/sitemap/0.9";
        ...
        //    {
        //        string link = "https://www.trinnk.com/sirketler/";
        //        writer.WriteStartElement("url");
        //        // required
        //        if (item.CategoryType == 3 || item.CategoryType == 5)
        //        {
        ...
        //        writer.WriteStartElement("url");
        //        // required
        //        string link = "https://www.trinnk.com/video/" + item.VideoId + "/" + Helpers.ToUrl(item.ProductName);
        //        writer.WriteElementString("loc", link);
        //        writer.WriteStartElement("video", "video", null);
        //        // start:optional
        //        writer.WriteElementString("video", "title", null, item.ProductName + " " + item.BrandName + " " + item.ModelName + " " + item.VideoId);
        ...
        //    {
        //        writer.WriteStartElement("url");
        //        string link = "https://www.trinnk.com/videolar/" + item.categoryid + "/" + Helpers.ToUrl(item.categoryname);
        //        writer.WriteElementString("loc", link);
        //        // start:optional
        //        writer.WriteElementString("priority", "0.5");
        //        writer.WriteEndElement(); //url
        ...
        //    var writer = new XmlTextWriter(path, Encoding.UTF8);
        //    XNamespace ns = "http://www.sitemaps.org/schemas/sitemap/0.9";
        //    const string url = "https://www.trinnk.com/sirket/";
        //    var _context = new TrinnkEntities();
        ...
        //    var urls = entries.ToDictionary(entry => "https://www.trinnk.com" + Helpers.ProductUrl(entry.ProductId, entry.ProductName), entry => DateTime.Now);
        //    var sitemap = new XDocument(
        //        new XDeclaration("1.0", "utf-8", "yes"),
        //        new XElement(ns + "urlset",
        //            from u in urls
