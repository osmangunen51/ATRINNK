    ...
    public class CategoryController : BaseController
    {
        ...
        public ActionResult ProductSearchOneStep()
        {
            ...
            if (searchText.Length >= 3)
            {
                ...
                {
                    searchScore = new global::Trinnk.Entities.Tables.Searchs.SearchScore
                    {
        ...
        public async Task<ActionResult> Index2(string selectedCategoryId, string SearchText)
        {
            ...
            {
                return RedirectPermanent("https://www.trinnk.com/urun-kategori-c-0");
            }
        ...
        public ActionResult AdvancedSearch(string category, string brand, string productGroup, string model, string sector, string serie, string city, string locality, string country)
        {
            ...
            int localityId = 0;
            int countryId = 0;
            var brandCategory = new global::Trinnk.Entities.Tables.Catalog.Category();
            var modelCategory = new global::Trinnk.Entities.Tables.Catalog.Category();
