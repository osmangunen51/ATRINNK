...
namespace NeoSistem.Trinnk.Web.Controllers
{
    ...
    public partial class VideosController : BaseController
    {
        ...
        //        ViewData["groupname"] = NeoSistem.Trinnk.Web.Helpers.StringHelpers.ToUrl(entities.Categories.Where(c => c.CategoryId == product.ProductGroupId).SingleOrDefault().CategoryName);
