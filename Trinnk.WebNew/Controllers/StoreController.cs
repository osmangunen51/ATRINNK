...
namespace NeoSistem.Trinnk.Web.Controllers
{
    ...
    public class StoreController : BaseController
    {
                    ...
                    foreach (var productItem in productsForStore)
                    {
                        if (productItem != null)
                        {
                            if (!string.IsNullOrEmpty(productItem.MainPicturePath))
                            {
                                ...
                                productModel.SmallPicturePath = ImageHelper.GetProductImagePath(productItem.ProductId, productItem.MainPicturePath, ProductImageSize.px200x150);
        ...
        public ActionResult Index()
        {
            ...
            {
                string redirectUrl = "https:://magaza.trinnk.com";
            ...
            if (string.IsNullOrEmpty(searchText))
            {
                ...
                model.CanonicalUrl = "https://magaza.trinnk.com" + request.Url.AbsolutePath;
            }
