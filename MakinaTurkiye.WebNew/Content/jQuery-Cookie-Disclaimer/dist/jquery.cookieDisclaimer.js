		...
		$.extend(Plugin.prototype, {
                ...
                cookieListner: function () {
                    ...
                    $('.cdbar-cookie-accept').on('click',function(e){
                        e.preventDefault();
                        $.cookie(plugin.settings.cookie.name, plugin.settings.cookie.val, { expires: plugin.settings.cookie.expire, path: plugin.settings.cookie.path, domain: '.makinaturkiye.com'  }); 
