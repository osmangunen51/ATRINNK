    ...
    $.ajax({
        ...
        data:
     {
        ...
        success: function (data) {
            if (data == true) {
                //                        $.facebox('\'' + storeName + '\' baþarýyla favori satýcýlarýnýza eklenmiþtir.');
                ...
                //    $.facebox('\'' + storeName + '\' firmasýný favori satýcýlýarýnýza eklemek için sitemize üye giriþi yapmanýz veya üye olmanýz gerekmektedir.');
            }
        },
        error: function (x, l, e) {
            $.facebox('\'' + storeName + '\' favori satýcýlarýnýza eklerken bir sorun oluþtu.');
        }
    });
}
...
function RemoveFavoriteStore(storeId, storeName) {
    //            var image = '<img src=\'/Content/Images/load.gif\' />'
    //            $.facebox('\'' + storeName + '\' Favori listenizden çýkarýlýyor.. &nbsp;&nbsp;' + image);
    $.ajax({
        ...
        data:
     {
        ...
        success: function (data) {
            //                    $.facebox('\'' + storeName + '\' favori satýcýlarýnýzdan çýkarýlmýþtýr.');
        ...
        error: function (x, l, e) {
            $.facebox('\'' + storeName + '\' favori satýcýlarýnýzdan çýkarýlýrken bir sorun oluþtu.');
        }
    });
}
...
function AddFavoriteProduct(id) {
    //            var image = '<img src=\'/Content/Images/load.gif\' />'
    //            $.facebox('Görüntülemiþ olduðunuz ürün favori listenize ekleniyor.. &nbsp;&nbsp;' + image);
    $.ajax({
        ...
        data:
     {
        ...
        success: function (data) {
            if (data == true) {
                //                        $.facebox('Görüntülemiþ olduðunuz ürün baþarýyla favori ürünlerinize eklenmiþtir.');
                ...
                //  $.facebox('Görüntülemiþ olduðunuz ürünü favori ürünlerinize eklemek için sitemize üye giriþi yapmanýz veya üye olmanýz gerekmektedir.');
                window.location.href = '/Uyelik/kullanicigirisi';
            }
        },
        error: function (x, l, e) {
            $.facebox('Görüntülemiþ olduðunuz ürünü favori ürünlerinize eklerken bir sorun oluþtu.');
        }
    });
}
...
function RemoveFavoriteProduct(id) {
    //            var image = '<img src=\'/Content/Images/load.gif\' />'
    //            $.facebox('Görüntülemiþ olduðunuz ürün favori listenizden çýkarýlýyor.. &nbsp;&nbsp;' + image);
    $.ajax({
        ...
        data:
     {
        ...
        success: function (data) {
            //                    $.facebox('Görüntülemiþ olduðunuz ürün favori ürünlerinizden çýkarýlmýþtýr.');
        ...
        error: function (x, l, e) {
            $.facebox('Görüntülemiþ olduðunuz ürün favori ürünlerinizden çýkarýlýrken bir sorun oluþtu.');
        }
    });
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data == true) {
                ...
                if (messagetype == 'message') {//üye giriþi yapmamýþ ve mesajdan gelmiþ popup acýlacak
        ...
        error: function (x, l, e) {
            $.facebox('Bilinmeyen bir hata oluþtu. Kýsa bir süre sonra tekrar deneyiniz.');
        }
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data) {
                ...
                //                $('[data-rel="memberEmail').validationEngine('showPrompt', 'E-Posta Adresiniz Sistemde Kayýtlýdýr.', 'red');
...
function PageChange(p, pd) {
    ...
    $.ajax({
        ...
        error: function (x, y, z) {
            alert('Bir Hata Oluþtu. Lütfen Destek Ekibimiz ile Ýletiþime Geçiniz');
        }
    });
...
function check() {
    if ($('#Member_MemberPassword').val() != $('#OldMemberPassword').val()) {
        alert("Girmiþ olduðunuz þifre, sistemimizde kayýtlý þifrenizle uyuþmamaktadýr.");
        return false;
    }
    else if ($('#Member_MemberEmailAgain').val() != $('#Member_NewEmail').val()) {
        alert("Girmiþ olduðunuz E-Posta adresleri uyuþmamaktadýr.");
        return false;
    }
    else {
        return true;
            ...
            $.ajax({
                ...
                success: function (data) {
                    response($.map(data, function (item) {
                        return { label: item.Text + " Firmalarý", value: item.Text + " Firmalarý", id: item.Value }
                    }))
                },
                error: function (x, l, e) {
