...
<asp:Content ID="Content3" ContentPlaceHolderID="TitleContent" runat="server">
    ...
    <%:Model.PageTitle %> Ekle - makinaturkiye.com
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div class="col-md-12">
            <h4 class="mt0 text-info"><%:Model.PageTitle %> Ekle
            </h4>
        </div>
    </div>
    <div class="row">
            ...
            <div class="well well-mt4 col-xs-12" style="background: #fff;">
                <div class="col-md-10">
                    <div class="alert alert-warning" role="alert">
                        Eklediğiniz <%:Model.PageTitle %> makinaturkiye.com anasayfasında ve firma sayfanızda gözükmektedir.
                ...
                <div class="col-md-12">
                    ...
                    <div class="alert alert-success" role="alert">
                        <%:Model.PageTitle %> eklenmiştir. En kısa sürede editörlerimiz tarafından incelenip onaylandıktan sonra aktif olacaktır.
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    ...
                    <%} %>
                    <%using (Html.BeginForm("Create", "StoreNew", FormMethod.Post, new { @class = "form-horizontal", @enctype = "multipart/form-data" }))
                        {%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-success" onclick="return Validation();">Ekle</button>
                        </div>
                    </div>
                    <%} %>
                </div>
