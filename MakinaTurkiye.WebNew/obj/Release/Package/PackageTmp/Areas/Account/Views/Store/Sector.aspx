...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div class="col-md-12">
            <h4 class="mt0 text-info">İlgili Sektörler
            </h4>
        </div>
    </div>
    <div class="row">
        <div class="well well-mt4 col-xs-12" style="background: #fff;">
            ...
            <%using (Html.BeginForm("Sector", "Store", FormMethod.Post))
                {%>
            ...
            <div class="col-md-9" style="margin-top: 20px">
                ...
                <table class="table">
                    <%foreach (var item in Model.StoreActivityCategories)
                        {%>
                    <tr id="storeSector<%:item.Key %>">
                        <td style="font-size: 14px;">
                            <%:item.Value %></td>
                        <td><a style="cursor: pointer" onclick="DeleteStoreSector(<%:item.Key %>)" title="Kaldır"><i class="fa fa-trash"></i></a></td>
                    </tr>
