...
<div class="col-xs-12">
 ...
 <%--       <span class="btn-group pull-right">
        <a href="#tab1" class="btn btn-md btn-mt" data-slide="prev"><span class="glyphicon glyphicon-chevron-left">
        </span></a><a href="#tab1" class="btn btn-md btn-mt" data-slide="next"><span class="glyphicon glyphicon-chevron-right">
        </span></a></span>--%>
    </div>
    <div class="panel-body ptb0">
      <div class="tab-content">
          ...
          <ul class="top-seller-list__items">
                            <%
                                int categoryid = Model.ProductDetailInfo.CategoryId.ToInt32();
