<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/StoreProfile.Master" Inherits="NeoSistem.MakinaTurkiye.Core.Web.ViewPage<NeoSistem.MakinaTurkiye.Web.Models.StoreProfiles.MTStoreDealerModel>" %>
                ...
                <div class="col-xs-4 col-md-2">
                    <div class="thumbnail thumbnail-mt">
                        <div class="caption text-left">
                            <b>
                                <%:Model.StoreDealers.FirstOrDefault(c=> c.StoreDealerId == item.StoreDealerId).DealerName %>
                            </b>
                            <br>
                            <p>
                                <%=Model.AdressEdits.First(x=>x.AddressId==item.AddressId).Address %>
                                <br />
