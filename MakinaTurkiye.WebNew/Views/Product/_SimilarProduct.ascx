...
<div class="col-xs-12">
    <div class="panel panel-mt2">
        <div class="panel-heading p0">
            <span class="btn btn-md disabled"><span style="margin:0; font-size:14px;">Benszer İlanlar</span></span>
            <a href="<%=Model.AllSimilarProductUrl %>" class="label text-sm label-success">Tümünü Göster </a>
        </div>
