                    ...
                    <div class="owl-carousel bottom-slider">
                        ...
                        <div class="item">
                            <div class="product-card-02" style="margin: 10px; min-height: 280px;">
                                <h3 class="product-content" style="min-width: 180px;">
                                ...
                                <div class="product-details clearfix">
                                    <%if (item.Index % 4 == 0 && item.Price == "Fiyat Sorunuz")
                                        {%>
                                        <div class="newest-item__body">
                                    <a href="<%:item.ProductUrl %>" class="btn btn-more">İlanı İncele</a>
                                </div>
                                    <% }
                                        else
                                        {%>
