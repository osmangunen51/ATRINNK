namespace NeoSistem.MakinaTurkiye.Web.Models.ViewModels
{
    ...
    using Banner = global::MakinaTurkiye.Entities.Tables.Common.Banner;
    using Seo = Entities.Seo;
    using Store = Entities.Store;
    ...
    public class ProductDetailViewModel
    {
        public ProductDetailViewModel()
        {
            ...
            this.Seo = new NeoSistem.MakinaTurkiye.Web.Models.Entities.Seo();
        }
