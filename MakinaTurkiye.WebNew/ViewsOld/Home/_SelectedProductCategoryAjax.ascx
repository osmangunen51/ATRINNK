    ...
    <div class="home-seleted-product-c">
        <div class="">
            <ul class="product-category-tab-container nav nav-tabs" id="myTab<%:m.Index %>" role="tablist">
                ...
                <li class="nav-item active all-selected hidden-xs">
                ...
                <%foreach (var item in m.CategoryModel)
                    {%>
                <li class="nav-item">
                    <a class="nav-item nav-link" id="<%:item.CategoryId %>-tab" data-toggle="tab" data-crousal="overflowdouble-p-<%:item.CategoryId %>" href="#<%:item.CategoryId %>" role="tab" aria-controls="<%:item.CategoryId %>" aria-selected="true">
                        <% string catName = item.CategoryName;
                            if (m.CategoryModel.Count > 3 && item.CategoryName.IndexOf(" ")>0) {
            ...
            <div class="tab-content" id="nav-tabContent<%:m.Index %>">
                ...
                <div class="tab-pane fade active in" id="<%:m.Index %>">
                    <div class="overflow-carousel-selected">
                        ...
                        <a class="left overflow-prev overflow-prev1-<%:m.Index %>" data-slide="prev"></a>
                        <a class="left overflow-next overflow-next1-<%:m.Index %>" data-slide="next"></a>
                    </div>
                ...
                <div class="tab-pane fade" id="<%:item.CategoryId %>" role="tabpanel<%:m.Index %>" aria-labelledby="<%:item.CategoryId %>-tab">
                    ...
                    <div class="overflow-carousel-selected">
                        ...
                        <a class="left overflow-prev overflow-prev1-<%:item.CategoryId %>" data-slide="prev"></a>
                        <a class="left overflow-next overflow-next1-<%:item.CategoryId %>" data-slide="next"></a>
                    </div>
