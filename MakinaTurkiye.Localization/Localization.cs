namespace MakinaTurkiye.Localization
{
    public static class Localization
    {
        ...
        public static string Get(string id, string culture, string Deger = "")
        {
        ...
        /// <returns>xml item id</returns>
        /// <returns>xml culture name</returns>
        public static string Localize(string id, string culture, string Deger = "")
        {
            return _loc.GetLang(id, culture, Deger);
        }
