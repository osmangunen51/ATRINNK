// <copyright file="ShortSqlParameter.cs" company="EnterpriseEntity">
...
namespace NeoSistem.EnterpriseEntity.Extensions.Data
{
    ...
    /// <summary>
    /// Short SqlParameter Extension Methods
    /// </summary>
    public static class ShortSqlParameter
  {
    /// <summary>
    ...
    public static DbParameter InSqlParameter(this short thisValue, string fieldName, int size = 0)
    {
    ...
    /// <param name="fieldName">Değişken Sql parametre adı</param> 
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter InSqlParameter(this short thisValue, string fieldName)
    {
    ...
    /// <param name="size">Değişken Sql parametre boyutu</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter OutSqlParameter(this short thisValue, string fieldName, int size = 0)
    {
    ...
    /// <param name="fieldName">Değişken Sql parametre adı</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter OutSqlParameter(this short thisValue, string fieldName)
    {
    ...
    /// <param name="size">Değişken Sql parametre boyutu</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter InOutSqlParameter(this short thisValue, string fieldName, int size = 0)
    {
    ...
    /// <param name="fieldName">Değişken Sql parametre adı</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter InOutSqlParameter(this short thisValue, string fieldName)
    {
    ...
    /// <param name="size">Değişken Sql parametre boyutu</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter ReturnSqlParameter(this short thisValue, string fieldName, int size = 0)
    {
    ...
    /// <param name="fieldName">Değişken Sql parametre adı</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    public static DbParameter ReturnSqlParameter(this short thisValue, string fieldName)
    {
    ...
    /// <param name="size">Değişken Sql parametre boyutu</param>
    /// <returns>DbParameter değer sonuçlar</returns>
    private static DbParameter CreateParameter(short thisValue, string fieldName, ParameterDirection direction, int size = 0)
    {
      return SqlParameterConverter.CreateParameter(fieldName, SqlDbType.SmallInt, thisValue, direction, size);
    }
  }
}